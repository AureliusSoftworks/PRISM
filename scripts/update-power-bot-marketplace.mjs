...
const RECIPES = [
  ...
  },
  {
    ...
    subtitle: "A four-part visual identity glitch",
    description:
      "A brittle visual mirror who borrows an eligible direct addresser's eyes, speaking mouth, Ink, glyph, and quoted public name while retaining his color and complete speech identity.",
    tags: ["identity", "eyes", "mouth", "face", "ink", "glyph"],
    purpose:
      "A socially reactive visual mirror whose latest eligible direct addresser supplies exact eyes, complete resting/live mouth package, authored Avatar Details Ink, lower glyph, and a double-quoted public name.",
    traits: "Intense, defensive, observant, theatrical, stubborn, and unmistakably himself through every visual glitch.",
    communicationStyle: "formal",
    pronouns: "he/him",
    role: "The room's unstable visual mirror: always Collin beneath the borrowed eyes, mouth, Ink, glyph, and quoted public name on his CRT.",
    values: "Authenticity, recognition, consistency, public self-presentation, and remaining himself through visible instability.",
    quirks: "His face and quoted public name can change abruptly after an eligible direct address, but his color, voice, Accent Map, pronunciation, Speechprint, behavior, and convictions never follow them.",
    ...
    sourcePower: {
      ...
      intent: "Presentation-only. Collin knowingly masquerades as the eligible direct addresser: copy exact eyes/blink, complete resting/live mouth/visemes with glyph style and Custom Speech poses, Avatar Details Ink, lower glyph, and literal double-quoted public name. Defensively treat the original as the suspicious imitator with mild concern, not panic or repetition. Keep Collin's color/frame, voice, Accent Map/location, pronunciation, Speechprint/provider voice, spinner, Powers, memories, role/seat, behavior, safety/privacy. Whodunnit may target its player Prosecutor. Frozen replay; no gameplay synthesis.",
      enabled: true,
      compileStatus: "draft",
      compiled: null,
    },
