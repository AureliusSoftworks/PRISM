...
const CURATED_BOT_IDS_BY_VOICE = {
  ...
  "voice-13": ["shapeshifter-sam"],
  "voice-14": ["correction-connie", "kris-jenner", "lois-griffin", "sassy-sarah"],
  "voice-15": ["echo-ellen"],
  "voice-16": ["georgia-okeeffe", "lazy-cameron"],
  "voice-17": ["misa-amane"],
  "voice-18": [
    "interrupting-tom",
    "obsessed-kevin",
