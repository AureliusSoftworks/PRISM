...
const jobs = [
  ["asterion-observatory-balanced-mosaic-v5.mansion", "asterion-observatory-tessera-mosaic-v6.mansion"],
  ["banyan-house-balanced-mosaic-v5.mansion", "banyan-house-tessera-mosaic-v6.mansion"],
  ["blackwood-house-balanced-mosaic-v5.mansion", "blackwood-house-tessera-mosaic-v6.mansion"],
  ["briarwatch-manor-balanced-mosaic-v5.mansion", "briarwatch-manor-tessera-mosaic-v6.mansion"],
];
...
for (const [inputName, outputName] of jobs) {
  ...
  decoded.manifest.roomArt = DEFAULT_MANSION_ROOM_ART_CONTRACT_V6;
  decoded.manifest.provenance.generatedWith = [
    ...new Set([
      ...decoded.manifest.provenance.generatedWith,
      "PRISM one-sample-per-tessera Mosaic presentation V6",
    ]),
  ];
