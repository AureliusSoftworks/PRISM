...
export const BOT_FACE_EYE_OFFSET_X_MIN = -0.36;
export const BOT_FACE_EYE_OFFSET_X_MAX = 0.36;
export const BOT_FACE_EYE_OFFSET_X_STEP = 0.02;
export const DEFAULT_BOT_FACE_EYE_OFFSET_Y = 0;
export const BOT_FACE_EYE_OFFSET_Y_MIN = -0.36;
export const BOT_FACE_EYE_OFFSET_Y_MAX = 0.36;
...
export const BOT_FACE_MOUTH_OFFSET_X_MIN = -0.36;
export const BOT_FACE_MOUTH_OFFSET_X_MAX = 0.36;
export const BOT_FACE_MOUTH_OFFSET_X_STEP = 0.02;
export const DEFAULT_BOT_FACE_MOUTH_OFFSET_Y = 0.18;
export const BOT_FACE_MOUTH_OFFSET_Y_MIN = -0.36;
export const BOT_FACE_MOUTH_OFFSET_Y_MAX = 0.36;
