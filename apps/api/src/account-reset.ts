...
export const FACTORY_RESET_USER_DATA_TABLES = [
  ...
  "audio_assets",
  "audio_asset_blobs",
  "debate_mystery_mansion_bundle_assets",
    ...
    const result = db
      .prepare(
        ...
        SET
          ...
          memory_acquisition_sensitivity = 'balanced',
          memory_short_term_days = 30,
          memory_long_term_threshold = 0.9,
          memory_inferred_min_evidence = 3,
          memory_inferred_threshold = 0.8,
          auto_switch_model = 0,
          auto_fallback_chain = NULL,
          online_auto_provider_bias = 0,
          online_auto_provider_weights = NULL,
          online_auto_quality_posture = 'quality',
          ...
          debate_whodunnit_text_voice_mode = 'bottish',
          debate_whodunnit_speech_type = 'english',
          debate_whodunnit_perspective = 'first_person',
          ...
          prism_default_bot_face_thinking_scale = NULL,
          prism_default_bot_face_thinking_offset_x = NULL,
          prism_default_bot_face_thinking_offset_y = NULL,
          ...
          ollama_cloud_key_ciphertext = NULL,
          ollama_cloud_key_iv = NULL,
          ollama_cloud_key_tag = NULL,
