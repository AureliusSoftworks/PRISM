  ...
  avatar: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "The established Eyes and Mouth controls operate the live bot. A meaningful customization brings that module's light online. Use the coordinate pad, sliders, presets, and keyboard controls here; drag the preview to pan and scroll it to zoom without changing the bot.",
