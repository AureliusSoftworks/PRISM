  ...
  debate: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Basic asks you to choose the two advocates while Prism takes the center Judge / Moderator seat, gives the automatic neutral introduction, then stays publicly silent and inactive until you act. Your gavel, question, pause, resume, and final ruling use that same avatar and player voice. After your ruling, both advocates react once before Prism gives the automatic neutral procedural close; Prism never invents a Judge action or changes your result. Surprise me can fill both sides. Advanced adds Participant and Spectator roles, a Library moderator, Random actors, and the optional five-seat Jury. Participant is Forum-only: choose your side, and PRISM becomes that entire advocate, leaving exactly you, the bot Moderator/Judge, and one bot opponent. Only duplicate bot seating is blocked; Powers never make a bot ineligible for a role.",
        clickLabel: "Debaters",
        targetSelector: '[data-tutorial-target="debate-cast"]',
      },
      {
        heading: "Secure advocacy consent",
        body: "Choose Make sure they’re willing after the question and debaters are set. This private LLM check protects every bot advocate: a genuine boundary can decline and cannot be overridden; a willing Devil’s Advocate keeps their identity and receives visible framing. A Participant is one of the two debaters, so PRISM holds their selected side directly and only the opposing bot needs advocacy consent. Changing the motion, cast, format, or formality clears the old check. Changing a Participant side does too.",
