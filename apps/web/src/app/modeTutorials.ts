...
const MODEL_ROUTING_VISIBILITY_TUTORIAL_SUFFIX =
  "Zen, Coffee, Signal, Debate, and Slate use the same persistent PRISM navbar: applet identity and switching first, contextual controls in the middle, and the shared utility strip at the right. Zen Home keeps its bot and Voice choices uncluttered; privacy, Model, and Effort appear once you open a bot chat. " +
