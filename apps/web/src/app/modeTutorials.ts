  ...
  avatar: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Identity, Eyes, Mouth, Details, Profile, Powers, Voice, SFX, and Settings remain available in the perimeter dock. On Identity, use Core for name and thinking, or Shell for body color and badge. Everything stays a draft until the top Save or Create bot action.",
