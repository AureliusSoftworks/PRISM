  ...
  zen: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "When a saved group is selected, Atmosphere keeps its reusable room backdrop. Marketplace groups begin with a stable bundled room you can replace with a saved or generated image. In a larger waiting room, a Listen up prompt stages 2-5 bots with that exact Coffee topic.",
    ...
    steps: [
      {
        ...
        body: "Pick a bot, then send your first message. Any ready Powers stay active with that bot across PRISM; a muted bot can still act, but only answers with ... and never speaks aloud, while an echo-bound bot repeats your addressed message exactly and adds nothing. A ghostly bot stays unseen while idle and fades into view only for its own spoken line; you can always understand the haunting through the conversation itself.",
        clickLabel: "a bot tile in the center picker",
        targetSelector: '[data-tutorial-target="chat-bot-picker"]',
      },
      {
        heading: "Make a room for a cast",
        body: "Use the plus beside the group filter to name a reusable group and choose its members. Open that saved room later to add, remove, or export its bots.",
        clickLabel: "the plus beside the group filter",
        targetSelector: '[data-tutorial-target="chat-new-group"]',
      },
      {
        heading: "Use quick tools",
        body: "Right-click in the canvas for shortcuts to settings, memories, images, and bot actions. In the account-wide Image hub, the sparkle audit previews generated files that have no current or historical applet reference; it never deletes anything.",
    ...
    steps: [
      {
        ...
        body: "Choose a Coffee Group here, or arrive from a group waiting room with its Listen up topic and locally ranked table already staged. Each bot brings its ready Powers to the table; Powers can change who they notice, answer, remember, privately read, how strongly they pull the room's attention, whether a trustworthy direct question draws a more candid next answer, whether they touch their coffee at all, mute them so only actions and ... remain, or make them repeat the exact user or bot line directly addressed to them. A ghostly bot is invisible at rest, fades in for its own line, then vanishes again; each appearance can leave the other bots rattled without taking their agency. If a hard-of-hearing bot asks what the prior speaker said, that bot repeats its saved line and loses a little mood each time.",
      ...
      },
      {
        ...
        body: "Once the table starts, type into the message box or let the bots carry the room. Watch a directly addressed bot: while listening, it may give a small nod, lean, expression, or brief spoken acknowledgement without taking a turn or entering the transcript. Your Cross-talk setting now controls how often those audible overlaps happen, from nearly silent in Rare to lively in Pile-up; inferred listeners remain visual only. If a reply takes long enough to leave dead air, another seated bot may make one brief mood-aware aside without stealing the slow bot’s turn. Sip and cup-return sounds stay synchronized with the visible cup motion. When an eligible bot has a non-neutral mood, Eleven v3 automatically carries that feeling into its next spoken line; neutral speech stays untagged. With Voice Effects on, longer bot turns may take a sparse mic-ready breath before speaking. Poll votes and team choices share the Table Talk rail; drag its left edge or the topic divider when you want more room.",
  ...
  botcast: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Signal keeps one primary speaker on mic at a time: their face comes alive and the transcript follows only the words they have finished saying. The listening host or guest may add a low-key nod, expression, or brief conversational acknowledgement during the line; calm backchannels overlap naturally without creating a turn or entering the transcript. Once the guest is genuinely annoyed, they can try to cut across the host with a brief audible interjection while the host keeps primary transcript ownership. Signal’s separate immersive reactions still belong to the performing bot, float above that bot, and appear between asterisks in the transcript without becoming fallback dialogue. Ask about a detail, press harder, move on, or lighten up at any time; Signal queues the private cue for the host’s next turn by default. If the guest has the mic or is next, Interrupt guest now gives the host that turn with the queued cue. Wrap it up is shared episode direction: both bots carry the closing exchange through to a real ending. The on-air clock shows elapsed episode time and freezes on the final duration. While Signal is on air, app switching and session-changing navbar tools stay locked; Voice remains available for the next line, while read-only Usage and Memories plus Theme remain available. Cut show immediately cuts away and archives the recording, then restores the full chrome; it does not discard the transcript. Choosing any show in the left rail while on air makes the same producer cut before Signal changes shows. Natural endings and hard cuts both land on a short, locally synthesized outro whose end card waits for you to return to the show. Freeform producer pressure or Press harder can earn resistance, a warning, and, rarely, a walkout.",
