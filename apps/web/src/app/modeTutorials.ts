                ...
                ? {
                    ...
                    body: compactAvatarSpeechStep.body
                      ...
                      .replace(
                        ...
                        "At the end, only a genuinely transparent PNG item whose exact upload hash is not already in Items offers an unchecked Keep in Items option. Prism supplies searchable keywords; choosing it writes that typed Item to the local asset database, links it to the bot guest it was presented to, and makes it available to future Whodunnit sessions and other item-based experiences. An exact match already in Items shows its saved status without another toggle.",
                      ),
                  }
                : compactAvatarSpeechStep;
