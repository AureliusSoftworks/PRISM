...
const IDENTITY_MIRROR_POWER_TUTORIAL_SUFFIX =
  "An identity-mirroring bot visually borrows exactly four things from the latest bot that directly addresses it: eyes, the complete resting and speaking mouth package, authored Avatar Details Ink, and the lower glyph. Its name, persona, dialogue behavior, complete authored voice and Accent Map, color, chassis/frame, Powers and consequences, thinking spinner, bot ID, seat, role, private perception, safety, provider, and every other field remain its own. The screen briefly powers down while the four-field overlay is installed, then reveals it. The saved handoff and timing replay exactly and reset with the session; the player is never copied.";
...
WHODUNNIT_TUTORIAL_STEP.body = WHODUNNIT_TUTORIAL_STEP.body
  ...
  .replace(
    ...
    "Identity Crisis visually borrows exactly the latest direct addresser’s eyes, complete resting and speaking mouth package, Avatar Details Ink, and lower glyph. The holder’s name, persona, dialogue, voice and Accent Map, color, chassis/frame, Powers and consequences, thinking spinner, and every other field remain unchanged.",
  );
