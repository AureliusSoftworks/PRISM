  ...
  debate: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Sources are optional. Add a note, or while AUTO or ONLINE choose Find sources for me so Prism runs one real-source search from the motion; it never fabricates sources. Advanced also exposes manual Brave search. LOCAL blocks research before network access, and Debate never reads or writes relationship memory.",
        clickLabel: "Sources",
