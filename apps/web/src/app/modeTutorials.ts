  ...
  debate: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "The compact proceeding card stays visible beside every Studio tool. It summarizes the motion, cast and consent, room, and evidence choice. Evidence itself stays optional, but you must explicitly use it or continue without it. Save Debate parks a ready setup in Archive Open without opening the chamber, and keeps generated exhibit images protected while that proceeding stays archived. Start Debate launches now.",
