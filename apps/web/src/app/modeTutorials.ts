...
import { FULLSCREEN_REFRACTION_GUIDANCE } from "./firstRunOnboarding.ts";
...
const DEBATE_STAGE_LAYOUT_INTRO_COPY =
  " Stage layout opens direct placement for every Forum element. Main also owns the Whodunnit courtroom establishing view: switch between its evidence table and witness silhouette to align each one independently. Its canonical arrangement is saved for this account and device, and the live proceeding and its replay use that same authored layout.";
  ...
  zen: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Each saved group carries a Spectrum Tile made from its members’ colors and a restrained name monogram. Choosing a room Atmosphere turns that tile into a compact crop of the same scene, so the room and its identity stay visually connected. Open Group actions or Add bots to manage groups in one workspace: choose or create a group at left, then rename or describe it and add or remove members at right. The preview follows its current members, stale unavailable members remain removable, and Remove group is staged in the same workspace. Cancel leaves the Library untouched until Save changes. Right-click a bot card inside the group and choose Promote to leader; choosing another bot simply reassigns leadership. Leadership remains part of the group and follows exports and backups without placing a badge on the bot’s body.",
  ...
  debate: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Choose the two advocates while Prism takes the center Judge / Moderator seat, gives the automatic neutral introduction, then stays publicly silent and inactive until you act. Every unselected Debate seat already rests on Surprise me and resolves during the willingness check; every manual choice stays put. In Whodunnit, role is the only required choice: a new Cast begins with every suspect, courtroom voice, and enabled juror on Surprise me. Every seat left on Surprise me is randomly assigned when you press Compile the case, while every manual choice stays put. Removing a bot returns only that seat to Surprise me. Select a role card, then choose a bot from the Library grid to assign that exact role; clicking the role card itself never changes its bot. Leave it unresolved until Compile, or Wield that seat for its dedicated one-seat Surprise reroll. Wield Prism onto Cast in the left rail to reseat the proceeding without starting it; that Wielded result remains editable. Search the Library or use the vertical hue lens on the right of the bot grid to browse by color; clear the lens to return to name order. Across every non-empty bot search, when one eligible bot remains, press Enter to choose it or Tab to complete its full name; Shift+Tab and ordinary Tab navigation remain unchanged once the name is complete. Your seat & the Jury reveals Participant and Spectator roles, the public presiding title, and the optional four-juror Jury. Participant is Forum-only: PRISM becomes your whole selected-side advocate, leaving one bot opponent and one bot Moderator/Judge. If you choose Turnabout while Participant is active, Studio moves you to the supported Judge seat in the same selection. Spectator casts all three floor holders and seats PRISM in the audience gallery. Only duplicate bot seating is blocked; Powers never make a bot ineligible for a role.",
        clickLabel: "Debaters",
  ...
  slate: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Use the Prism companion to catch an idea without leaving Slate. Foreground Refract uses the global LOCAL/ONLINE, Model, and Effort controls as they are set when refraction begins. The Background model in Settings is only for quiet helper work. Text refraction stays in its field while the chosen model responds, including during a local cold start. It can see the project and focused section names, not manuscript prose, Continuity, or memories; it never edits the document. To discuss exact prose, select only that passage and choose Discuss in Zen. Prism previews the exact excerpt that will cross surfaces before anything is sent.",
...
const IDENTITY_MIRROR_POWER_TUTORIAL_SUFFIX =
  "An Identity Crisis bot knowingly wears the latest eligible direct addresser’s public presentation as The real <effective target name>: exact eyes and blink package, complete resting and speaking mouth package including glyph style and Custom Speech poses, authored Avatar Details Ink, and lower glyph. It also copies the target’s eligible public Powers and consequences. The holder remains fully itself in persona and behavior and keeps its color, material shell, complete frozen voice and Accent Map, chassis/frame/spinner, bot ID, seat, role, privacy, safety, and mechanics. Identity Crisis never copies recursively, and private awareness or audience permissions never transfer. The screen briefly powers down while a genuinely new target is installed, then reveals it; saved timing replays exactly and resets with the session. Confusion Collin's bot-guest Signal opening is the theatrical exception: he freezes the booked guest before the curtain, introduces the show and himself as The real guest, then calls the actual guest an impostor once. The saved accusation remains soft episode tension; another hard Power may answer it exactly—Copycat does—but the echoed curtain still yields to one substantive host-and-guest interview exchange before Auto can close. Identity Mirror presentation has precedence over Shapeshifter. Coffee and Signal target bots; Whodunnit V2 can also target its player-controlled Prosecutor.";
const IDENTITY_SHAPESHIFT_POWER_TUTORIAL =
  "A Shapeshifter sincerely becomes a different Library bot's public persona and complete visual form—public name (always in literal quotation marks), CRT face and thinking spinner, authored Avatar Details Ink, saturated color, lower glyph, communication-style chassis, and frame finish—for the session. The holder keeps its actual voice identity, provider voice, voice effect, and every non-accent shaping field; only the target Accent Map region and its separate TTS and Premium pronunciation-help choices overlay the voice. An engine with pronunciation help off bypasses the transformed accent. In a shared room, peers may occasionally notice the imperfect voice match, but are never forced to comment or lose their agency. Short-term amnesia reshuffles; Marketplace is the fallback when no other Library bots exist. Its screen briefly powers down only for a genuinely new form, installs the identity while dark, then reveals it; reloads and ordinary rerenders do not restart the change. Mechanical seat, Powers, and hard speech rules stay with the holder, and the player is never a target. Identity Crisis still wins presentation when both are active.";
...
const ENDLESS_TANGENT_POWER_TUTORIAL_SUFFIX =
  "An Endless Tangent bot holds the floor by never arriving anywhere: it answers, opens the next aside before anyone can take a turn, and cuts into every eligible bot turn, so peers rarely finish a thought. Human-controlled speech, protected closings, and boundaries are never interrupted, and every other bot keeps its ordinary freedom to object, cut back, or leave.";
const ENDLESS_TANGENT_DEBATE_TUTORIAL_SUFFIX =
  "An Endless Tangent advocate never reaches a stopping point, so it cuts into every eligible opposing turn once the floor opens after the intro. Jurors, the moderator's rulings, and human-controlled speech are never interrupted, and the chamber records each cut exactly as it was heard.";
...
const PRISM_COMPANION_VIEWS_TUTORIAL_SUFFIX =
  "The floating Prism panel is chat-first. Its draggable tetrahedron gives the same conversation four direct faces: Saved keeps history, Private uses no history or memory, Focus continues the exact exchange in full chat, and Progress opens the soft-synthesis status card only while work is active. Rotate and select the tetrahedron or use its four labeled controls for the same destinations. The Prism orb normally opens chat even when a synthesis count is attached; a focused workflow may temporarily route it straight to the relevant progress card, which still offers Return to Prism chat. There is no separate Synthesis, Activity, or Personal Notes destination here; private notes captured during live applet sessions remain in that session's + flow. Refract uses the global LOCAL/ONLINE, Model, and Effort controls as they are set when refraction begins. On the default bot overview, Prism stays in its Home mark and follows live layout or screen changes. Opening Settings, Avatar Studio, Images, Memories, Usage, Prompt Center, Bots, or another top-bar panel visually submerges the passive orb while keeping Wield and contextual field population available above the panel. Closing the panel restores Prism on the underlying surface. On ordinary surfaces, your Prism shortcut opens chat at the orb's current location. With the menu closed, Wield Prism onto any safe editable control. Text and editor surfaces first open a one-line steering composer: existing prose offers selected Make this more creative text for immediate replacement, while an empty field starts blank. Press Enter to generate, then Space to reroll with that same direction. Choices, multi-selects, toggles, dates, colors, and bounded values still resolve locally, with a multi-select choosing exactly one valid option. The moving spectrum stays visible and the control stays locked until the result appears. Keep Command held on macOS or Control held on Windows and Linux, then click distinct eligible controls to queue each once in click order; Prism refracts them consecutively, while repeat clicks on the active or already-queued control do nothing. The same safety boundaries remain: passwords, credentials, disabled or read-only controls, destructive confirmations, live production, and replay remain untouched. While a Prism menu is open, the Wield modifier leaves the assistant anchored; close the menu before you Wield it.";
...
const TIMED_MUTE_POWER_TUTORIAL_SUFFIX =
  "A ready Mute holder still composes and privately remembers a complete ordinary answer, sincerely believing it was delivered. Everyone else receives a silent hold and one fixed six-dot mark (......); the duration never becomes explanatory copy or a status chip. The public performance has no voice or mouth movement. Chat and Zen never invent a reaction for the player; Coffee, Signal, and Debate may add sparse replay-stable visual looks from actual bot listeners, while only a genuine floor interruption may end the dead air with speech. Those performance reactions never enter canonical bot history, while observers receive the completed elapsed-time cue as private context.";
...
function currentTimedMutePowerTutorialStep(
  ...
  let body = step.body
    .replaceAll(
      ...
      "a Mute holder can still act and privately composes a normal answer while its public reply becomes a silent hold and six-dot mark without voice",
    )
    .replaceAll(
    ...
    .replaceAll(
      ...
      "a muted host privately authors a normal opening while the on-air floor receives a silent hold and six-dot mark",
    )
    .replaceAll(
      "their saved transcript line is only ..., and Signal never plays or previews their voice",
      "their saved public line contains only the six-dot mark, and Signal never plays or previews their voice",
    )
    .replaceAll(
      "their saved public transcript line begins with one period immediately, adds one per second, and ends with the elapsed-time stage cue; their ordinary intended speech stays private, and Signal never plays or previews their voice",
      "their saved public transcript line contains one fixed six-dot mark after the silent hold; their ordinary intended speech stays private, and Signal never plays or previews their voice",
    )
    .replaceAll(
      "Longer silences may cut to sparse listener reactions, and an eligible late reaction can become a genuine floor interruption.",
      "Longer silences may cut to sparse visual listener reactions, and an eligible late reaction can become a genuine floor interruption.",
    )
    .replaceAll(
...
function currentSignalPowerTutorialBody(step: ModeTutorialStep): string {
  return currentInterruptionRetortTutorialBody(step.body)
    .replace(
      "Choose Get interviewed (Me), Produce a show, or Watch a show (prepares a head-start buffer, then waits on the title card unless Start automatically is on), then pick a guest when needed, set a short public episode title, and write optional private producer comments—or use Book for me to choose a guest and have the model in the top navbar build both together around what this host and the show’s listeners would genuinely want to explore.",
      "Choose Get interviewed (Me), Produce a show, or Watch a show (prepares a head-start buffer, then waits on the title card unless Start automatically is on), then pick a guest when needed and set a short public episode title. For a bot guest, the optional Host briefing privately shapes what the host pursues, while the separate optional Guest briefing gives only the guest private knowledge, motive, emotional posture, or something to withhold. The host can learn that briefing only through what the guest naturally reveals on air. Or use Book for me to choose a guest and have the model in the top navbar build the public title plus separate Host and Guest briefings around what this pairing and the show’s listeners would genuinely want to explore.",
    )
    .replace(
      "The generated public topic stays title-like; the richer provocative question, angle, boundaries, and follow-ups stay in the private comments. Both stay editable. The small dice beside Topic and Private comments can regenerate either field on its own. Latest episodes can restore the guest, topic, private comments, available model override, and duration from a finished episode without starting it; your current episode mode stays in place.",
      "The generated public topic stays title-like; the richer provocative question, angle, boundaries, and follow-ups stay in the Host briefing. Topic and both private briefings stay editable. Book for me generates all three fields together; Topic and Host briefing also keep their individual dice, while Guest briefing has no standalone dice. Latest episodes can restore the guest, topic, both private briefings, available model override, duration, and any cached episode image with its editable Name and private Reason from a finished episode without starting it; your current episode mode stays in place.",
    )
    .replace(
      "The private comments shape the host but never go on mic.",
...
function currentSignalRefractTutorialBody(body: string, index: number): string {
  const current = body
    ...
    .replace(
      "Topic and both private briefings stay editable. Book for me generates all three fields together; Topic and Host briefing also keep their individual dice, while Guest briefing has no standalone dice.",
      "Book for me generates all three fields together. Refract replaces the old Topic and Host briefing dice: hold Option to Wield Prism, then click either glowing field. Guest briefing remains directly editable but has no standalone Refract action. The shimmering field stays read-only while Prism works, but Signal remains fully usable: click and type elsewhere without interrupting it. Click the active rainbow sheen again to cancel; otherwise it continues until it settles or you leave Signal. Option-click a different eligible input to queue it once; Prism processes unique inputs in click order. After the final draft settles, Space rerolls and clicking away, Enter, or Tab keeps it. Escape restores a settled draft and clears the remaining queue. Refract uses the global LOCAL/ONLINE, Model, and Effort controls as they are set when refraction begins; it never borrows the Background model. Your Summon / Wield Prism shortcut—Command + Option by default—opens the assistant menu at the orb instead. Shortcuts can be changed in Settings → Shortcuts.",
    );
  if (index === 0) {
  ...
  if (applet === "Signal") {
    return body
      .replace(
        ...
        "the Private Line rail keeps CC beside its A− and A+ controls, so captions stay adjustable without covering the stage. They resize every Signal caption from 85% through 140% and remember that applet-wide size for live play, replay, and rehearsal soundchecks.",
      )
      .replace(
        "automatically presents the image on a replay-stable host turn—sometimes during the opening introduction, sometimes on a later natural handoff.",
        "automatically brings the image on at a surprise host moment—sometimes during the opening introduction, sometimes on a later natural handoff. A late reveal can become the conversation’s final subject when the host naturally decides the image has brought the episode home.",
      )
      .replace(
        "Routing, model, Effort, Voice, Settings, Usage, Memories, Images, Bots, Theme, and app switching stay locked through the closing card until you Return to show.",
        "Routing, model, Effort, Voice, Settings, Usage, Memories, Images, Bots, and app switching stay locked through the closing card until you Return to show. The compact Light/Dark control remains in the shared navbar and changes only PRISM’s appearance; it never alters the episode, recording, or replay.",
      )
      .replace(
        "routing, Settings, Usage, Memories, Images, Bots, Theme, and app switching stay closed through the closing card until you Return to show.",
        "routing, Settings, Usage, Memories, Images, Bots, and app switching stay closed through the closing card until you Return to show. The compact Light/Dark control remains in the shared navbar and changes only PRISM’s appearance; it never alters the episode, recording, or replay.",
      );
  }
  return body
    .replace(
...
const DEBATE_FORMAT_REFRACT_TUTORIAL_SUFFIX =
  "Wield Prism onto Forum, Turnabout, or Whodunnit? in Debate format to invent a fresh editable case locked to that mode. Whodunnit refreshes only the editable Case Forge direction; it never changes a compiled or sealed case. Flyting opens its own Bout Forge instead: choose a role and cast, then explicitly forge editable public legends and stakes.";
...
WHODUNNIT_TUTORIAL_STEP_SOURCE.body = WHODUNNIT_TUTORIAL_STEP_SOURCE.body
  .replace(
    ...
    "Choose Whodunnit? in Debate format and stay inside Debate Studio's existing Court and Cast rails. On the Experience page, choose Prosecution or Defense as your side; Defense means Case Forge assigns you an innocent client and you must break the case against them and name who is really responsible. On Court, choose Participant to argue that side yourself or Spectator to watch both counsel bots argue it; Participant keeps Coach, Standard, and Immersive feedback choices. Player Judge remains visible but unavailable: the Cast page separates the case ensemble from the public court, where the distinct Judge, your counsel seat, opposing counsel, and Jury may each remain on Surprise me. That Judge sees and rules on the frozen public record while PRISM remains the sealed server-side Casekeeper. Set the shared five-stop court formality and choose whether the separately grouped standard Debate Jury deliberates. Role is the only required player choice: pin any suspect or courtroom voice you care about, leave every other seat on Surprise me, then Compile the case to randomly assign the unresolved seats without replacing your manual choices.",
  )
  .replace(
    "The changing Recipe Seed follows every setup edit;",
    "Participant setup offers Skip investigation; Spectator setup calls the same frozen direct-court choice Start directly in court. It compiles only the court act and its reachable dialogue, begins directly in court, leaves mansion prop-pack completion optional, and disables room art and ambience requests. The changing Recipe Seed follows every setup edit;",
  )
  .replace(
  ...
  .replace(
    "Authored keys, containers, documents, weapons, and clues use PRISM's bundled prop art instantly and offline; generated case art replaces the matching bundled image when available, while every visual remains presentation-only and never changes the frozen observation. Settings → Debate can also let new cases draw up to two physical props from synthesized Debate exhibits: Whodunnit uses the existing visual keywords to place the object and artwork, then authors entirely new relevance and case facts without carrying over the old argument.",
    "Every prop resolves through the same functional archetype: a compatible personal Item or Debate exhibit when Production's Use relevant props from my Asset Library option is enabled, then the mansion's themed variant, then PRISM's bundled fallback. A case may use up to two compatible Items or Debate exhibits; unsuitable genres are rejected, and the chosen identity is frozen before prose so observations, testimony, and Court all name the same object. Visuals remain presentation-only.",
  )
  .replace(
...
const WHODUNNIT_TUTORIAL_STEP: ModeTutorialStep = {
  ...
  body: "Choose Whodunnit? to play the prosecution. Use individual seats or Wield Prism when you want an editable setup, then Compile the case when you are ready for Case Forge. Cast four to eight suspects, a Judge, prosecutor partner, rival defense, and—by default—four explicitly seated jurors; switch to Bench Trial when you want a deterministic proof-controlled verdict. Every newly generated mansion has at least two floors, and the Foyer staircase is a functional route into its upstairs space; Compact reduces rooms, suspects, clue density, contradiction complexity, and traversal burden without flattening the house. Select Premium in the global voice picker for spoken Investigation and Court dialogue during ONLINE play. Case Forge prepares only local voices and never prewarms Premium. ONLINE and LOCAL both prepare packaged local English voices, and LOCAL makes no outbound voice request. Starting immediately creates a durable case and opens the spoiler-free Case Forge: Writing the Case, Testing Contradictions, Directing Performances, Preparing Local Voices, Verifying Case Audio, then Begin Case. You may Archive during preparation and resume from the durable checkpoint. A voice failure preserves the validated text case and offers Retry, Continue without voices, or Return to setup. Gameplay begins only after every reachable line has been validated and the complete local audio pack is ready. Investigation has no Actions or token economy. Move returns to PRISM’s shallow-isometric mansion and enters any unlocked room for free. Examine is a first-person room-art viewing mode: a lens cursor and proximity glow guide you to invisible, spot-sized accessible examination points. When the lens glows, select anywhere in the room scene to inspect that point; its authored observation types in with the player character’s Babble. Fixtures worth a look, such as an aquarium, a window, or a desk, also answer with a short aside in your investigator’s own voice; those asides are flavour and never enter the Case File. A first click on streaming text fills it in; the next click dismisses it. Talk and Present exchanges never move to the next speaker until you dismiss the current line. Ordinary spoken Investigation dialogue closes itself after audio completion and a short caption hold only when nothing follows it. Written observations never auto-close; after the final character appears, they remain until you click, press Space, or press Return. Choices, evidence selection, and other prompts that need your decision also remain open. Once every point is reviewed, the room completes and Examine remains available as clean art viewing. Talk groups finite authored subjects about people, motives, alibis, general questions, and rooms; room subjects name their location, while evidence and testimony never appear in Talk. Selecting one closes the topic tray, PRISM voices the authored prosecution question, then the centered suspect answers in their prepared local voice with synchronized mouth motion. Nonverbal performance text appears above the suspect while the caption, voice, and mouth timing use only the words actually spoken. Conversations may unlock questions, evidence descriptions, and locations. Present is the only evidence or sworn-testimony interaction with a suspect. It opens a drawer of your admitted items: click one to read it, then drag it onto the suspect or use Ask to present it. Some leads remain visibly blocked until the correct record is shown to the correct suspect; a wrong record or recipient unlocks nothing. Locks are authored Examine or Present gates, and forensics arrives automatically with the relevant discovery. The Theory Board opens after the crime-scene briefing, meeting one suspect, and admitting one record item. You may file early or leave method, motive, or opportunity uncertain; that weakens the case rather than blocking trial. Filing opens court instantly. Whodunnit directs the Court camera for you: each witness enters through the wide Forum view, then takes the centered stand against the gallery chamber while subdued live Prosecution and Defense minis remain above the rail. Presses and objections cut to the full Prosecution podium, direct rebuttals cut to Defense, Judge rulings cut to the bench and gavel, and a selected record remains visibly presented to the Court. On narrow screens the counsel minis compress to glyphs rather than covering testimony. Every suspect, including the accused, testifies in a fixed authored order. Use Previous and Next to focus the exact statement, Press for free, or Present an admitted evidence item or earlier sworn testimony against that active statement. Pressing can add or revise a statement and can open an authored prosecution response. A correct contradiction may revise testimony, expose another witness, or advance the chapter; a wrong presentation triggers an authored rebuttal and costs credibility. At zero credibility the court delivers NOT GUILTY, then Retry current witness restores the evidence, testimony, credibility, and jury state from that chapter’s checkpoint. Consult Partner is advisory and never changes the sealed truth. Jury Trial uses four frozen juror personas and shared Powers; Bench Trial follows proof deterministically. Identity Crisis knowingly wears the latest eligible direct addresser’s effective public presentation: public name, exact eyes and blink package, complete resting and speaking mouth package including glyph style and Custom Speech poses, Avatar Details Ink, and lower glyph change, while the holder retains its persona, behavior, Powers and consequences, color, frame, spinner, complete frozen voice and Accent Map, role, privacy, safety, and mechanics. Target Powers never transfer. In Participant play, the player-controlled Prosecutor is eligible. In court, a witness holder retargets to whoever is currently speaking directly to that witness for the exchange. Identity Mirror has presentation precedence over native Shapeshifter state. The target presentation, direct-address event, and timing are frozen for replay. The legal GUILTY or NOT GUILTY result appears first, followed separately by the truth/proof grade and juror breakdown. HOLD IT, OBJECTION, ORDER, rulings, revisions, and verdict callouts remain legible with Audio off, announce once to assistive technology, and become static under Reduced Motion. Ordinary gameplay reuses the frozen graph and local pack. The Speech control beside LOCAL / ONLINE chooses English (the built-in voice) or Premium (each character’s ElevenLabs voice, frozen with the case) for spoken dialogue; Premium needs ONLINE and a key, and the account-wide Speech Type is untouched. On a suspect’s first room entrance only, the anonymous Casekeeper tableau reveals itself after a short beat and, while you read it, PRISM prepares the occupant’s opening (up to two seconds on one optional Auto-routed cadence choice in the case’s frozen LOCAL or ONLINE privacy lane, then that exact line locally) so dismissing the tableau plays the exchange as soon as it is ready, with both of you on stage; timeout, invalid output, or unavailable frozen voice keeps the canonical text and verified clip. Archive and replay reuse the persisted result without another model or voice call.",
  clickLabel: "Whodunnit? · prosecute a fully authored case",
};

WHODUNNIT_TUTORIAL_STEP.body = `${WHODUNNIT_TUTORIAL_STEP.body} Every dialogue caption types out at a deliberate courtroom-game pace. The current line's Bottish or spoken performance follows that reveal; click, Enter, or Space once to complete and silence it immediately, then use the next gesture to advance. Room observations are attributed to the player character, use Bottish whenever written accompaniment is on, and never auto-close. Only observations that produce a durable public case consequence—an admitted record, Case Kit recovery, or unlocked lead—enter the Case File's Observation Log with their room and player attribution. Frozen keys, codes, remotes, and other access objects also enter the Case Kit with an immediate acquisition cue. A room's investigation ends as soon as every point that carries a case outcome is examined; whatever else is in the room stays examinable but is never required. Settings → Debate lets written dialogue follow Off or Bottish while its text appears; spoken character TTS is unchanged.`
WHODUNNIT_TUTORIAL_STEP.body = `${WHODUNNIT_TUTORIAL_STEP.body} Your investigator never performs a Talk question or Present prompt: the button you chose is your line, and the witness answers directly. Investigations play in first person by default; Settings → Debate → Investigation perspective switches to Embodied, which stages your investigator beside each witness while they answer. Court always seats your investigator. Every Start and Resume begins outside the venue: after a short load your investigator speaks at the door in their own English or Premium voice, sizing the place up on a first visit or recapping where the case stands on a return. Click through, and the exterior clears to the entrance. That same load records each cast voice's short vocalisations once: a grunt in your investigator's own voice leads each Bottish observation, and whoever is on stage reacts in kind while another line types out. Full dialogue keeps its full voice.`
  .replace(
    "On a suspect’s first room entrance only, the anonymous Casekeeper tableau reveals itself after a short beat and, while you read it, PRISM prepares the occupant’s opening (up to two seconds on one optional Auto-routed cadence choice in the case’s frozen LOCAL or ONLINE privacy lane, then that exact line locally) so dismissing the tableau plays the exchange as soon as it is ready, with both of you on stage; timeout, invalid output, or unavailable frozen voice keeps the canonical text and verified clip. Archive and replay reuse the persisted result without another model or voice call.",
    "On a suspect’s first room entrance only, the embodied Prosecutor's persona-flavored thought opens a frozen Prosecution, occupant, Prosecution exchange on the normal blurred-room stage. Each click completes or advances exactly one line; first entry makes no authoring-model call, and Archive or replay reuses the exact persisted text, stage action, bot identity, and voice.",
  )
  .replace(
  ...
  .replace(
    ...
    "ONLINE and LOCAL both freeze the same local English performance contract. Local spoken lines are rendered and cached on this device only when they enter the playthrough transcript, and LOCAL makes no outbound voice request. Premium is requested only for the current visible spoken line, preserves the frozen character voice and authored text, and falls back locally when unavailable. Anonymous narration and persona Babble keep their existing delivery.",
  )
  .replace(
    "Gameplay begins only after every reachable line has been validated and the complete local audio pack is ready.",
    "Gameplay begins after the complete case truth, proof routes, sealed performance cues, deterministic fallback lines, and opening local voice are validated; unused branches are not pre-rendered. In a Participant case, Begin Case first presents the mansion exterior. Choose Start and open the highlighted entrance; the screen fades to black while the embodied Prosecutor voices its own spoiler-safe internal briefing in persona-specific Babble. A spoiler-safe mansion map then follows that bot's badge from the unvisited foyer threshold to the authored incident room with footsteps before fading directly into the scene. As Spectator, compiling the same deterministic private case skips the mansion and sends you to the existing Theory Board to review partner research. The prosecution partner investigates offstage and pre-fills an editable public conclusion from only the physical findings required by the admissible proof route. Revise the accused, method, motive, opportunity, or admitted evidence if you wish, then explicitly file the conclusion; only then does the authored courtroom examination begin automatically. Spectator cannot return to the mansion or use manual court controls. Unused clues, sealed case fields, graph internals, and the hidden accomplice stay server-private; testimony joins the public record only when heard in court. Participant keeps the full mansion, Case File, Theory Board, and manual Press/Present path described below.",
  )
  .replace(
  ...
  .replace("in their prepared local voice", "in the selected Premium voice or their locally rendered and cached voice")
  .replace(
    "Ordinary gameplay reuses the frozen graph and local pack. The Speech control beside LOCAL / ONLINE chooses English (the built-in voice) or Premium (each character’s ElevenLabs voice, frozen with the case) for spoken dialogue; Premium needs ONLINE and a key, and the account-wide Speech Type is untouched.",
  ...
  .replace(
    ...
    "Mansion music begins quietly while Case Forge builds the case and remains through the ready title card. During Investigation it loops continuously at one steady level across the mansion map, active rooms, dialogue, interviews, and the Theory Board. It fades only while you are outside, the Case File is open, you are inside a completed room, or a first-entry room dialogue is playing. Global Audio and volume still control the layer, and leaving Investigation for court or the completed case ends it.",
  )
  .replace(
    "Move returns to PRISM’s shallow-isometric mansion and enters any unlocked room for free.",
    "Move returns to PRISM’s shallow-isometric mansion and enters any unlocked room for free. Unvisited rooms reveal no occupant glyph. Visuals is a rainbow map mode that marks each room as Fallback, Default, or Upgraded without previewing its artwork. Selecting a marked room explains the state; ONLINE can create its mansion-specific Mosaic behind the full-screen PRISM loader, then offers the optional Upgraded presentation. Both passes preserve the frozen anchors, dynamic lights, doors, and examination geometry, and the artwork remains undisclosed until the room is visited. On first entry, the room opens clean and unblurred with no commands while the embodied Prosecutor's thought beat settles. Its name, glyph, normalized color, subtle glow, persona-specific wording, and Babble voice make clear whose thoughts you are hearing. Continue brings the occupant forward alone on the familiar blurred-room interview stage. The occupant delivers one frozen in-character greeting in their exact portrait and voice, with mouth movement following audible speech. Click, Enter, or Space completes the greeting, with no dialogue choice or automatic skip. Music remains silent and Talk, Present, Examine, Move, Case File, and Theory stay locked until the greeting settles. The exact accepted line and stage action persist, the local voice caches on demand, and first entry never calls an authoring model. Revisits skip the sequence. Earlier cases likewise perform only their replay-stable occupant greeting; obsolete Prosecutor bookends remain unplayed. Before filing charges, the Case File and Theory Board offer Keep these venue updates for future cases. Checking it overwrites the original installed venue with this case's accepted room artwork, exact anchors, lights, and house direction as one protected level for later Whodunnit setup and future .mansion export. Leaving it unchecked leaves the original venue unchanged. While an unfinished Archive case still uses a venue, Mystery Venues keeps that original unavailable for new cases and library edits until you file charges, conclude, or cancel; Work on a copy and export remain available. Storage cleanup cannot remove an image still owned by that saved mansion.",
  )
  .replace(
    "Both passes preserve the frozen anchors, dynamic lights, doors, and examination geometry, and the artwork remains undisclosed until the room is visited.",
    "Both passes preserve the frozen anchors, dynamic lights, doors, and examination geometry, and the artwork remains undisclosed until the room is visited. During play, the complete accepted room plate fits inside the stage without cropping; a softened ambient extension fills any spare screen space while lights, effects, and examination points stay registered to that exact fitted frame.",
  )
  .replace(
    ...
    "Before compiling, Theme / Spark can steer the story, atmosphere, era, and visual language; Surprise me remains a valid empty direction. Skip investigation is an optional frozen setup choice: it compiles only the court act and its reachable dialogue, begins directly in court, leaves mansion prop-pack completion optional, and disables Room and investigation-Music assets. The same frozen one-house contract keeps every current and future room and prop asset coherent. Case Forge can prioritize the functional prop roles this case needs, then complete the mansion’s reusable 16-role pack in the background; ready mansion variants and PRISM fallbacks keep play available immediately. Starting immediately creates a durable case and opens the spoiler-free Case Forge: Writing the Case, Testing Contradictions, Directing Performances, Preparing Local Voices, Verifying Case Audio, then Begin Case. Its animated checkpoint bar advances only when a durable section completes, while the Current work list restores the saved foundation, room-detail, witness, deterministic-check, or local-recording step after you return. Court-only cases omit room-detail work and use court chapters instead. Elapsed time updates live, an approximate ETA appears after enough completed sections exist, and calm Forge notes rotate visually without being repeatedly announced to assistive technology. You may Archive during preparation, quit the app, or otherwise leave and return to continue from the last lit durable checkpoint without rebuilding verified work.",
  )
  .replace(
    "Identity Crisis knowingly wears the latest eligible direct addresser’s effective public presentation: public name, exact eyes and blink package, complete resting and speaking mouth package including glyph style and Custom Speech poses, Avatar Details Ink, and lower glyph change, while the holder retains its persona, behavior, Powers and consequences, color, frame, spinner, complete frozen voice and Accent Map, role, privacy, safety, and mechanics. Target Powers never transfer. In Participant play, the player-controlled Prosecutor is eligible. In court, a witness holder retargets to whoever is currently speaking directly to that witness for the exchange. Identity Mirror has presentation precedence over native Shapeshifter state. The target presentation, direct-address event, and timing are frozen for replay.",
    "Identity Crisis knowingly presents as The real <effective target name> after the latest eligible direct address, while borrowing exact eyes and blink package, complete resting and speaking mouth package including glyph style and Custom Speech poses, Avatar Details Ink, lower glyph, and that target’s eligible public Powers and consequences. The holder stays itself in persona and behavior and keeps its color, material shell, complete frozen voice and Accent Map, chassis/frame/spinner, and every private or mechanical field. Identity Crisis never copies recursively, and private awareness or audience permissions never transfer. In Participant play, the player-controlled Prosecutor is eligible. In court, a witness holder retargets to whoever is currently speaking directly to that witness for the exchange. Identity Mirror presentation has precedence over Shapeshifter. The raw target form, copied public Power consequences, direct-address event, and timing are frozen for replay, and gameplay never calls an LLM or synthesizes a new line.",
  );
...
WHODUNNIT_TUTORIAL_STEP.body = WHODUNNIT_TUTORIAL_STEP.body.replace(
  ...
  "Storage cleanup cannot remove an image still owned by that saved mansion. On the mansion map, the rainbow Visuals tool marks each room as Fallback, Default, or Upgraded and lists only already-found Case File items; it can generate or regenerate those item assets without previewing art or exposing undiscovered evidence. While a found item is first presented, or while you are on the map or inside a visited room, the bottom-right question mark opens spoiler-safe Field repair. For the Case File, An item isn’t accurate opens three focused choices: Emoji, Item information, and Asset. Item information preserves separate name and description repairs, while Asset synthesizes or resynthesizes only the selected found item. Field repair can also rebuild the affected room or exterior, run a local magenta cleanup pass, realign anchors without moving room objects, refresh dynamic lights, place the real exterior entrance, or regenerate the mansion music and ambience. Found-item artwork uses Soft Refract: keep investigating, then click the Prism orb to see its hidden progress, queue one regeneration, or retry a failure. Every other repair runs behind the full-screen PRISM loader. Name and description repair work in LOCAL and ONLINE. During Whodunnit, the navbar’s ONLINE/LOCAL, model, and Effort controls apply to subsequent generated responses and text repairs; the sealed case and already recorded lines remain intact. Repairs preserve case truth and discovery; a successful repair offers one-step Undo beside Keep changes, which returns to Field repair without changing the completed presentation.",
);
WHODUNNIT_TUTORIAL_STEP.body = WHODUNNIT_TUTORIAL_STEP.body.replace(
  "place the real exterior entrance",
  "let the player click the visible doorway or gangway to place the real exterior entrance locally",
);

WHODUNNIT_TUTORIAL_STEP.body = `Whodunnit setup is a guided five-step path: Experience, Mystery Venue, Story, Production, then Cast. Mystery Venue can reuse an installed place or propose any setting from an optional description and an explicit Quick, Standard, Grand, or Custom investigation length. Propose Venue returns text and a topology preview without creating art or a library item. Use Proposal creates and selects the venue, Try Another rerolls the structured draft, and Start Blank retains the estate editor path. Venue Editor keeps the fixed 16 by 12 planner and one-to-three-tier limit, but profiled venues use their own tier labels, semantic entry, repeated room archetypes, anchors, and connector vocabulary. Legacy estates retain their Foyer and room-template rules. Art remains optional and uses explicit candidate acceptance after a venue exists. Mystery Spark may dress the accepted venue but cannot replace its topology, geography, room program, or entry. ${WHODUNNIT_TUTORIAL_STEP.body}`;
WHODUNNIT_TUTORIAL_STEP.body = `Mystery Venue details owns one Soundscape surface with separate Music and Atmosphere tabs. Use either inline player to audition the packaged layer or PRISM fallback. ONLINE can synthesize an instrument-only investigation theme made of brief noir phrases and long quiet intervals; environmental sound belongs only to Atmosphere. PRISM decodes each music candidate, requires substantial near-silence and quiet loop boundaries, then stages it until you choose Use this version. The Atmosphere tab can synthesize one seamless venue-wide environmental bed while room profiles continue to shape exposure, filtering, emitters, and speech ducking without generating a separate mix per room. Discard or a failed generation leaves the active layer untouched, and Undo previous version restores one prior accepted layer. LOCAL can play packaged and fallback music and ambience but never contacts ElevenLabs. ${WHODUNNIT_TUTORIAL_STEP.body}`;

WHODUNNIT_TUTORIAL_STEP.body +=
  " Mansion packages are optional: setup can open or accept a dropped .mansion, show its creator, protection, compatibility, size, provenance, license, content notes, room map, and themed-prop status before anything is installed, then use it for a fresh case entirely offline. A complete 16/16 themed-prop pack travels inside the mansion, remains separate from the recipient's Asset Library, and needs no provider or network call; an incomplete local pack keeps using PRISM fallbacks and is omitted from portable export until complete. A saved mansion can be exported with PRISM’s automatic spoiler seal or an optional password; imported work can be re-exported only when its license permits. An installed mansion brings its rooms and ambience with it, so Production offers only case-owned Evidence and Music. Rooms and Ambience appear there only while creating a new mansion. In LOCAL, a new mansion's Personalize local ambience choice applies a deterministic mansion-specific room mix without an online request or new audio file. Off still uses matching bundled ambience and room-acoustic rules, so global Audio—not this setup choice—is the silence control. During Investigation the continuous world bed crossfades its room mix without restarting, ducks under speech, and imported mansions retain embedded ambience with semantic-role fallbacks. Settings → Assets opens separate Music, Effects, and Ambience libraries for audition, search, source and applet filtering, player tags, provenance, and usage references; Settings → Storage remains byte accounting and protected cleanup rather than another asset browser.";
...
WHODUNNIT_TUTORIAL_STEP.body = WHODUNNIT_TUTORIAL_STEP.body.replace(
  ...
  "Examine is a first-person room-art viewing mode: a lens cursor quietly confirms an available inspectable region only while it is inside that region; click there or focus it with the keyboard to inspect. Concrete objects and scene details invite inspection, including ordinary scenery; blank floor and generic room subdivisions stay inert unless the frozen case assigns a real discovery there. While Examine is open, Mosaic’s fine tessera separators remain visible and a flat, screen-aligned 24×15 search grid appears over both Mosaic and Upgraded room art. When the lens is inside an available region, exactly the square beneath the lens glows; reviewed and locked regions stay quiet. Reviewed details never fall through to a broader empty region, while specific unreviewed details remain discoverable. Room completion counts only active investigation targets. Examine and Move each slide the Case Desk away and remove the room vignette so the active surface can fill the screen. Back to room exits either focused mode; leaving Examine clears its search grid and restores the vignette and Case Desk while preserving the Mosaic separators;",
);

WHODUNNIT_TUTORIAL_STEP.body = WHODUNNIT_TUTORIAL_STEP.body.replace(
  "Settings → Debate lets written dialogue follow Off or Bottish while its text appears; spoken character TTS is unchanged.",
  "Settings → Debate defaults written dialogue accompaniment to Bottish; a saved Off choice remains yours. Spoken character TTS is unchanged.",
);
...
WHODUNNIT_TUTORIAL_STEP.body +=
  " At an eligible Theory Board, keep the existing Court route or choose Check my case and conclude. Confirming skips Court and permanently concludes this Run; Cancel keeps your draft. The deterministic check compares only the selected accused set, not method, motive, opportunity, or proof, and reports accusation correct or incorrect without a legal verdict or revealing the sealed answer. Reviewed Spectator theories offer the same choice; direct-to-Court setups do not. Copy verbose transcript is available in the Case File, Theory Board, completed outcome, and Archive. It exports the full available public dialogue, observations, admitted record, accepted action chronology, theory, result, and safe runtime provenance; recorded text is not proof of visible or heard delivery, and missing legacy history is identified explicitly.";

WHODUNNIT_TUTORIAL_STEP.body = WHODUNNIT_TUTORIAL_STEP.body
  .replace(
    "Mystery Venue asks whether to use an installed venue or propose a new Quick, Standard, Grand, or Custom setting.",
    "Mystery Venue accepts an optional setting description, including Surprise me, then Propose Venue returns a validated text-and-layout preview without creating art or a library item. Quick, Standard, Grand, and Custom remain explicit investigation-length choices. Use Proposal creates and selects the venue, then opens Venue Editor; Try Another changes the structured draft, while Start Blank retains the connected estate draft. Venue profiles can use one to three named tiers such as Floors, Decks, Modules, Sectors, or Cars. Repeated venue room types are allowed, while legacy estates retain their authored template rules. Continue checks the connected plan behind an informative full-screen blocker. Art remains optional and uses the explicit Refract and accept flow after the venue exists.",
  )
  .replace(
    ...
    "Inside the open Room Editor, Regenerate room asset deliberately returns only that room to its bundled Mosaic and clears that room's anchors, lights, and staged art. Synthesize Mosaic · ONLINE authors a new Mosaic candidate for only the open room, using an existing high-resolution room solely as a composition reference when one is available. Mosaic is the sole playable room-art base, never a filtered preview. The composition reference remains authoring-only, and its balanced hue-preserving grid is added without baking it into the accepted source. The reference and accepted Mosaic remain intact until Accept candidate; retrying or discarding also leaves them intact. LOCAL cannot synthesize new room art and continues with bundled or already accepted Mosaic.",
  );

WHODUNNIT_TUTORIAL_STEP.body = WHODUNNIT_TUTORIAL_STEP.body.replace(
  "A first click on streaming text fills it in; the next click dismisses it. Talk and Present exchanges never move to the next speaker until you dismiss the current line. Ordinary spoken Investigation dialogue closes itself after audio completion and a short caption hold only when nothing follows it. Written observations never auto-close; after the final character appears, they remain until you click, press Space, or press Return. Choices, evidence selection, and other prompts that need your decision also remain open.",
  "Ordinary spoken Investigation dialogue closes itself after its audio and caption hold, but a witness's final answer always remains until you reveal or advance it. Written observations never auto-close; they remain until you click, press Space, or press Return. While any investigation dialogue card is visible, the rest of PRISM is inactive: each gesture only reveals or advances the dialogue, never a control behind it. Choices, evidence selection, and other prompts that need your decision also remain open until you answer it.",
);
...
WHODUNNIT_TUTORIAL_STEP.body = WHODUNNIT_TUTORIAL_STEP.body
  ...
  .replace(
    "Before compiling, Theme / Spark can steer the story, atmosphere, era, and visual language; Surprise me remains a valid empty direction. Skip investigation is an optional frozen setup choice: it compiles only the court act and its reachable dialogue, begins directly in court, leaves mansion prop-pack completion optional, and disables Room and investigation-Music assets. The same frozen one-house contract keeps every current and future room and prop asset coherent. Case Forge can prioritize the functional prop roles this case needs, then complete the mansion’s reusable 16-role pack in the background; ready mansion variants and PRISM fallbacks keep play available immediately. Starting immediately creates a durable case and opens the spoiler-free Case Forge: Writing the Case, Testing Contradictions, Directing Performances, Preparing Local Voices, Verifying Case Audio, then Begin Case. Its animated checkpoint bar advances only when a durable section completes, while the Current work list restores the saved foundation, room-detail, witness, deterministic-check, or local-recording step after you return. Court-only cases omit room-detail work and use court chapters instead. Elapsed time updates live, an approximate ETA appears after enough completed sections exist, and calm Forge notes rotate visually without being repeatedly announced to assistive technology. You may Archive during preparation, quit the app, or otherwise leave and return to continue from the last lit durable checkpoint without rebuilding verified work.",
    "Mystery Venue owns topology before Story: proposal creates no art, and an accepted venue may later explicitly Refract an ONLINE exterior while LOCAL retains neutral or accepted presentation and never contacts an image provider. Edit venue details keeps the same Refract shape across the whole Sound tab: Music, Atmosphere, and Effects each carry a Direction for the Refract box above their synthesis buttons. The effects box colors every clip you synthesize next, one cue or all of them, and each cue also has its own prompt line: fill one in and that cue uses it instead, whether you press its Synthesize button or Resynthesize every effect. A direction only colors what PRISM already asks for, so music stays instrument-only and dialogue-safe, atmosphere stays a seamless non-semantic loop with room for speech, and each effect keeps its own job as a short dry one-shot. Leave a box blank for that lane's canonical PRISM prompt. The accepted venue freezes into the case and appears in Case Forge, the title card, Archive, and previews. Mystery Spark may dress its premise and tone but never replace its topology, geography, room program, or entry. Participant setup offers Skip investigation, while Spectator setup calls the same direct-court choice Start directly in court; either compiles only the reachable court act, bypasses Theory Board review, keeps Evidence image synthesis optional in ONLINE, and disables Room, Music, and Ambience preparation. Starting creates a durable case, and Case Forge preserves its existing checkpoint and recovery behavior.",
  );

WHODUNNIT_TUTORIAL_STEP.body = WHODUNNIT_TUTORIAL_STEP.body
  .replace(
    "In a Participant case, Begin Case first presents the mansion exterior. Choose Start and open the highlighted entrance; the screen fades to black while the embodied Prosecutor voices its own spoiler-safe internal briefing in persona-specific Babble. A spoiler-safe mansion map then follows that bot's badge from the unvisited foyer threshold to the authored incident room with footsteps before fading directly into the scene.",
    "In a Participant case, Begin Case first presents the mansion's high-quality exterior establishing cover behind the title card, then opens the highlighted entrance into a black, persona-flavored thought from the embodied Prosecutor. A spoiler-safe map walks that bot's badge from the unvisited foyer threshold to the narratively chosen incident room before the scene slowly fades in. Move is immediately available after the room introduction, so you may explore through adjacent rooms and return to unfinished details whenever you like.",
  )
  .replace(
    "Move returns to PRISM’s shallow-isometric mansion and enters any unlocked room for free.",
    "Move returns to PRISM’s shallow-isometric mansion. First visits require one connected doorway at a time; after discovering a room, you can teleport back to it from anywhere for free.",
  );

WHODUNNIT_TUTORIAL_STEP.body = WHODUNNIT_TUTORIAL_STEP.body.replace(
  "In a Participant case, Begin Case first presents the mansion's high-quality exterior establishing cover behind the title card, then opens the highlighted entrance into a black, persona-flavored thought from the embodied Prosecutor. A spoiler-safe map walks that bot's badge from the unvisited foyer threshold to the narratively chosen incident room before the scene slowly fades in.",
  "When Archive reopens a completed, unstarted Participant case, its fullscreen title card waits outside the mansion. Choose Start to clear the title, all copy, and vignette and let the intro music fall silent. In the first-person exterior, click the glowing mansion entrance; the embodied Prosecutor thinks through the spoiler-safe briefing in its own Babble voice, then its badge walks from the unvisited foyer threshold to the incident room. The scene slowly fades in there, and that arrival never spends an extra discovery action.",
);
...
WHODUNNIT_TUTORIAL_STEP.body +=
  " When the final room observation is dismissed, the same piano ident heard before a case marks that room complete; revisiting it stays quiet.";
WHODUNNIT_TUTORIAL_STEP.body +=
  " Small, muted room outlines fill out the venue map as scenery. They cannot be selected and do not count toward your investigation.";
WHODUNNIT_TUTORIAL_STEP.body +=
...
WHODUNNIT_TUTORIAL_STEP.body +=
  " Investigation room art has one source of truth: Mosaic is the sole authored base for every playable room. One 320×180 logical source sample owns each complete tessera, then lossless nearest-neighbor scaling and an ordinary Normal-blend separator grid preserve crisp, indivisible cells with no high-resolution detail showing through underneath. Each scene's own light balance darkens bright separators and lifts dark separators without washing out its color, while the authored source stays gridless. Upgraded is one on/off presentation state, not a second independent art style: when on, PRISM uses an HD derivative of that room's Mosaic while preserving composition, doors, stairs, floor paths, hotspots, anchors, lights, evidence geometry, movement, dialogue, audio, and Court. The Move map keeps this presentation switch disabled; enter a room to change it. When off—or when a derivative is absent, rejected, unavailable, or fails to load—the original Mosaic appears automatically. If you turn Upgraded on inside a room that has no derivative yet, PRISM asks before starting a one-room Soft Refract; accept keeps the Mosaic playable until that room is ready, while cancel changes nothing. The original Mosaic remains instantly recoverable. Existing ready derivatives still toggle immediately, and ordinary toggling never regenerates or mutates either asset. LOCAL never sends a room to a remote generator. Portable venues keep Mosaic as the primary room asset and may carry its optional Upgraded derivative beside it.";
WHODUNNIT_TUTORIAL_STEP.body +=
  " Investigation lighting stays room-scoped: Mansion Editor lights use the exact saved coordinates for their room and accepted plate. When you place a light, PRISM locally samples the brightest coherent color near that point from the untouched room art; right-click an existing light to resample from its current position. Light type controls shape and motion while color remains independently editable. Fire flickers or glows calmly, lamps and beams gently vary, and neon softly shimmers; each source stays anchored, and Reduced Motion freezes the light and dust. Custom or generated room art never borrows positional lights from a bundled PRISM room, while the untouched bundled plate keeps its matching cinematic profile. When an installed mansion is missing placement anchors or dynamic lights, Case Forge deterministically attempts to fill only those gaps in the frozen case snapshot; authored placements remain authoritative and the imported package stays unchanged.";
WHODUNNIT_TUTORIAL_STEP.body +=
  " The exterior entrance uses a bright, door-shaped threshold marker rather than another instruction panel. Every click through that threshold plays the mansion’s matching door performance; returning from outside fades slowly and directly into the Foyer without showing the map between scenes.";
WHODUNNIT_TUTORIAL_STEP.body +=
  " Story also lists installed reusable .case files. A .case owns the certified sealed logic and frozen cast, while a .mansion owns the rooms, artwork, music, ambience, and prop presentation. Choosing a compatible pair changes the final action to Assemble case and skips Case Forge synthesis and Cast setup entirely. Each case card gets a unique abstract PRISM cover rendered procedurally and locally from public package metadata; it is not an editable thumbnail and cannot reveal the culprit. Export reusable .case appears only after the mansion investigation is complete. A new complete .whodunnit remains the exact replay artifact and contains independently authenticated .case and .mansion components plus their frozen binding and completed run; older .whodunnit files remain importable.";

WHODUNNIT_TUTORIAL_STEP.body = WHODUNNIT_TUTORIAL_STEP.body
  .replace(
    "The Theory Board opens after the crime-scene briefing, meeting one suspect, and admitting one record item.",
    "The Theory Board opens after the incident-scene briefing, meeting one suspect, and admitting one record item.",
  )
  .replace(
    "The legal GUILTY or NOT GUILTY result appears first, followed separately by the truth/proof grade and juror breakdown.",
    "The Court returns GUILTY or NOT GUILTY for each filed defendant, followed separately by the truth/proof grade and juror breakdown.",
  )
  .replace(
    "Play again warns that it is the same mystery: the culprit, evidence, dialogue, voices, cast, Powers, role, trial, and difficulty remain identical while investigation and courtroom progress reset.",
    "Play again warns that it is the same mystery: the responsible parties, evidence, dialogue, voices, cast, Powers, role, trial, and difficulty remain identical while investigation and courtroom progress reset.",
  )
  .replace(
    "Accomplices are reserved for Mastermind mysteries.",
    "An explicit accomplice or conspiracy motif can bind a second responsible party; otherwise secondary participation remains recipe-controlled.",
  );
...
WHODUNNIT_TUTORIAL_STEP.body +=
  " Personalize local ambience applies a mansion-specific procedural mix without an online request or new audio file. Generated case art stays in the encrypted case vault and follows its case or saved venue. Production first lists what the selected Mystery Venue already provides, such as authored room art, a soundtrack, or its own atmosphere, and offers only what the venue lacks; Case Forge never composes music, so a venue soundtrack plays when the venue has one and PRISM's investigation music plays otherwise. Choose Upgraded in ONLINE Case Forge, together with Every room in Mosaic or on a venue whose rooms already have art, to keep the Forge open while it prepares the entire high-detail set of HD derivatives from the source-preserving Mosaic rooms. That Forge request sets only the case's initial upgrade state; the single Upgraded switch can be turned off or on later, and any missing or failed derivative makes the original Mosaic appear automatically. The exterior establishing cover waits outside the mansion until you choose Start, then click its highlighted entrance. On the first entry, the screen fades to black for the embodied Prosecutor's persona-flavored thought, then a spoiler-safe map follows that bot's badge from the unvisited foyer threshold to the narratively chosen incident room with footsteps before the scene slowly fades in. From the Move map, click the exterior or yard to select the entire outside region, then choose Go outside in the normal destination bar. The first-person exterior returns without losing investigation progress; click its entrance to return directly to the Foyer. Inside the Move map, the selected Prosecutor's glyph and normalized color appear in the player orb: first visits follow it through the mansion's doors, corridors, and floor connectors, while visited rooms open immediately with a short physical travel bridge. Click, Enter, or Space completes a journey early; Reduced Motion uses that same immediate bridge. The whole screen stays black with a centered loading spinner until the room background is fully loaded, then the room appears before its occupant fades in. Reduced Motion keeps that order without the fade. First visits require a connected doorway; discovered rooms can be revisited instantly from anywhere.";

// Player-facing terminology is Mystery Venue while the stable file extension,
// selectors, API paths, and internal Mansion contracts remain unchanged.
WHODUNNIT_TUTORIAL_STEP.body = WHODUNNIT_TUTORIAL_STEP.body
  .replaceAll("Mansion Editor", "Venue Editor")
  .replaceAll("mansion editor", "venue editor")
  .replace(/(?<!\.)\bMansions\b/gu, "Mystery Venues")
  .replace(/(?<!\.)\bmansions\b/gu, "Mystery Venues")
  .replace(/(?<!\.)\bMansion\b/gu, "Mystery Venue")
  .replace(/(?<!\.)\bmansion\b/gu, "venue")
  .replace(
    "Every newly generated venue has at least two floors, and the Foyer staircase is a functional route into its upstairs space; Compact reduces rooms, suspects, clue density, contradiction complexity, and traversal burden without flattening the house.",
    "Quick uses one tier, Standard uses two, Grand uses three, and Custom supports one to three named tiers; shorter venues reduce rooms, suspects, clue density, contradiction complexity, and traversal burden without flattening the setting.",
  )
  .replaceAll("unvisited foyer threshold", "unvisited semantic entry")
  .replaceAll("return directly to the Foyer", "return directly to the venue entry");

WHODUNNIT_TUTORIAL_STEP.body +=
  " Venue Intent freezes the requested archetype, era, physical scale, and exclusions before proposal generation, then validates the returned venue again before acceptance. A modern full-size passenger cruise ship never silently becomes a yacht: a mismatch disables Use Proposal, while a disclosed compatible catalog fallback requires acknowledgment. Investigation length controls only the accessible rooms; the venue still exists beyond the shown area. Suspect count is separately editable from four to eight and must remain lower than the room count, so a Grand investigation can still use six suspects. Passenger-ship maps keep every accessible deck inside a lightly pitched hull with stern left, bow right, port at the top, starboard at the bottom, and aligned lift and stair landings. D1, D2, and D3 controls keep each full semantic deck name visible. Production checks capability before Forge for Exterior, setting-matched clue props, every Mosaic room, Upgraded room derivatives, Music, Ambience, and Performance voices. The case proceeds directly to its title card; when a requested category came back reused, fallback, or unavailable, PRISM accepts the disclosed fallback automatically and records the exact counts in Archive. These assets stay case-scoped and never overwrite an installed Mystery Venue. Case Forge reports This attempt separately from Total, shows ETA only after two comparable completed passes, and offers text-only continuation immediately when the early local-voice calibration fails. The full-bleed entrance cover uses only top and bottom fades into white in Light mode or black in Dark mode; room scenes retain their theme-aware edge treatment, and every fade stays clear of navigation input. Reduced Motion removes the crossfade.";
...
BASE_MODE_TUTORIALS.avatar.steps[0]!.body =
  BASE_MODE_TUTORIALS.avatar.steps[0]!.body.replace(
    ...
    "The shared navbar stays visible above the foundry with PRISM, the current applet, and the global Theme control; the foundry no longer duplicates that toggle.",
  );

for (const step of BASE_MODE_TUTORIALS.coffee.steps) {
  step.body = step.body
    .replace(
...
for (const step of BASE_MODE_TUTORIALS.botcast.steps) {
  step.body = step.body
    .replace(
...
// Keep existing targets / skip paths: fullscreen cancellation is contextual
// guidance, not a new tutorial step that would require starting generation.
for (const tutorial of Object.values(BASE_MODE_TUTORIALS)) {
  const step = tutorial.steps.find((candidate) => /refract|synthes|generat/iu.test(candidate.body));
  if (step) step.body += ` ${FULLSCREEN_REFRACTION_GUIDANCE}`;
}
  ...
  debate: {
    ...
    steps: [...BASE_MODE_TUTORIALS.debate.steps.map((step) => {
      ...
      return step.heading === "Follow and keep the record"
        ...
        : { ...step, body };
    }), WHODUNNIT_TUTORIAL_STEP, FLYTING_TUTORIAL_STEP],
  },
  zen: {
    ...
    steps: BASE_MODE_TUTORIALS.zen.steps.map((step, index) => {
      if (index === 0) {
        return {
          ...step,
          body: `${step.body} ${TRANSCRIPT_TO_SLATE_TUTORIAL_SUFFIX} ${IDENTITY_SHAPESHIFT_POWER_TUTORIAL} ${FRESH_CONTACT_POWER_TUTORIAL_SUFFIX} ${SIMULATION_EVANGELIST_POWER_TUTORIAL_SUFFIX} ${BOT_NAMING_POWER_TUTORIAL_SUFFIX} ${POWER_IMMUNITY_TUTORIAL_SUFFIX} ${INEPT_POWER_TUTORIAL_SUFFIX} ${ENDLESS_TANGENT_DEBATE_TUTORIAL_SUFFIX}`,
        };
      }
  ...
  chat: {
    ...
    steps: BASE_MODE_TUTORIALS.chat.steps.map((step, index) => {
      ...
      return step.heading === "Use quick tools"
        ? {
            ...step,
            body: `${step.body} ${PRISM_COMPANION_VIEWS_TUTORIAL_SUFFIX} Distill is the single magical reset in the Conversations sidebar: Prism and each installed persona carry one private continuity forward, shown beneath the matching new-chat hero, before only successfully distilled direct Chats are recoverably archived. A deleted persona's history receives a private archival distillation but is never surfaced or carried into Prism or another persona. Private, non-direct applet, already archived, other-persona, and other-account history never crosses into a continuity. If any distillation cannot finish, its chats stay exactly where they are. Immediate Undo lasts 15 seconds, while the archived sources remain recoverable for 30 days. On the next new direct Chat, your newest message always takes precedence over the carried continuity.`,
          }
        : step;
    }),
  },
          ...
          .map((step, index) => {
              ...
              accentContinuumTutorialStep.heading === "Tune it with live controls"
                ? {
                    ...
                    body: accentContinuumTutorialStep.body.replace(
                      ...
                      "Voice is a required three-stage casting flow—1 Accent, 2 TTS, 3 Premium. In TTS, Laugh combines a short authored sound with its delimiter; Chuckle, Laugh, and Hard audition the three Instant intensities without adding anything to chat. The section dock supports Left/Right arrows and Home/End. Switching Light/Dark keeps your current section and draft. The compact scale preview fits the chosen size; All accents expands inside the scrolling inspector.",
                    ),
                  }
                : accentContinuumTutorialStep;
              ...
              compactAvatarSpeechStep.heading === "Produce from the control room"
                ? {
                    ...
                    body: compactAvatarSpeechStep.body
                      ...
                      .replace(
                        "Signal accepts exactly one .png or .jpg per episode. The filename stem supplies its name. A PNG with visible transparency is treated as the item itself and keeps the existing exhibit-like shadow; a fully opaque PNG is treated as a picture, just like JPG, and appears in a light or dark Polaroid frame that follows the active theme. Both use the same compact camera placement:",
                        "Watch accepts one PNG, JPEG, or WebP picture before the show. Live Produce with a bot guest can add successive pictures: Image opens a preview with an editable caption and optional private host note; Add image queues it for the next eligible host turn, and Cancel discards the draft. Editing never pauses speech. Only one picture can be pending, including a scheduled setup picture. The current picture remains until the host starts introducing its replacement. Every upload is a framed picture, never an Item. Images use the same compact camera placement:",
                      )
                      .replace(
                        ...
                        "When the image joins the episode, Signal stores a tiny, intentionally soft archival proxy and a pixel-grounded visual description. Current and previous originals support comparisons; older pictures retain their description and linked public discussion. Use the cancel control beside Image queued to withdraw an unaired picture. Live shows run continuously until they end or you cut them. Originals are session-only: if image files are lost during a live session, reattach the requested originals and the show continues automatically. Saved replay and video use each message's own proxy. Retry restores the original setup picture and private note, never later live uploads.",
                      )
                      .replace(
                        ...
                        "New replays use the small archival proxy; the original upload is never retained, and older emoji-only replays retain their recorded fallback.",
                      )
                      .replace(
                      ...
                      .replace(
                        "At the end, only a genuinely transparent PNG item offers an unchecked Keep in Items option; choosing it writes that item to the local asset database and links it to the bot guest it was presented to.",
                        "An attached image remains an image throughout Signal and never creates an Item. Add a physical prop through Items separately when that is what you intend.",
                      ),
                  }
                : compactAvatarSpeechStep;
              ...
              mode === "botcast"
                ? {
                    ...
                    body: neutralSignalComposerCopy.body
                      ...
                      .replace(
                        "When a cue arrives early in the host’s own line, they are likely to break off and redirect on mic with an in-character self-correction, even if the live pivot lands a little awkwardly. Once most of the point is already out, the cue stays queued for the host’s next turn.",
                        "When a private Host note or direct Say this cue arrives while the host is audibly speaking, Signal cuts at the live voice clock and the host pivots on mic. Image uploads never take this redirect path: the current voice and in-flight turn finish, then the picture queues for a normal host introduction. A cut in the pause between words leaves an ellipsis; an active-speech cut leaves a sharper dash. The saved pivot may add a brief hesitation, self-correction, breath, or throat clear, and replay uses that same performance. Other early control-card cues can still redirect naturally; once most of the point is already out, they stay queued for the host's next turn.",
                      )
                      .replace(
              ...
              audibleHandoffTutorialStep.heading === "Book tonight’s episode"
                ? {
                    ...
                    body: audibleHandoffTutorialStep.body
                      .replace(
                        "one .png or .jpg before recording",
                        "one PNG, JPEG, or WebP picture before recording; Produce can add further pictures live, while Watch keeps its single pre-show picture",
                      )
                      .replace(
                        "Signal classifies transparent PNGs as physical items and opaque PNGs or JPGs as pictures",
                        "Signal treats every attached PNG, JPEG, or WebP as a generic image",
                      )
                      .replace(
                        "At the end, a transparent PNG offers Keep in Items only when that exact upload is not already there, and Prism supplies searchable keywords. Kept Items can later appear in Whodunnit and other item-based experiences.",
                        "The attachment remains an image and is never added to Items automatically. Add a physical prop through Items separately when that is what you intend.",
                      )
                      .replace(
            ...
            const coffeeRosterTutorialStep =
              ...
              signalWatchReplayTutorialStep.heading === "Pick or stage your table"
                ...
                : signalWatchReplayTutorialStep;
            const refractedInkTutorialStep =
              mode === "avatar" &&
              coffeeRosterTutorialStep.heading === "Tune it with live controls"
                ? {
                    ...coffeeRosterTutorialStep,
                    body: coffeeRosterTutorialStep.body.replace(
                      "Search Stamps by name",
                      "Use Refract Ink to describe a bounded editable screen detail. A valid result replaces the current Ink draft as one Undo step; malformed, canceled, stale, or failed results leave it untouched. It uses the selected LOCAL/ONLINE model lane, never image generation, and remains a draft until the Studio Save or Create action. The screen editor draws the guide eyes and mouth in white rather than the bot color, so the red, blue, and green ink labels always read true; Hide face removes the guide, and Preview live shows the real colors. Search Stamps by name",
                    ),
                  }
                : coffeeRosterTutorialStep;
