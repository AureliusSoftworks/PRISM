  ...
  debate: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "In Basic, describe the idea in ordinary words and choose Build the debate. Prism makes one balanced motion, names both sides, and writes the briefs you should not have to author; Try another version gives you a fresh framing. The floating Prism remains available throughout setup and understands the bounded, unsaved workbench draft. Wield Prism into a glowing setup field—or use your Prism modifier + Space while that field is focused—for a contextual editable candidate shaped by the current format, Rowdiness, role, cast, motion, and evidence. Space rerolls; Enter or Tab accepts; Escape restores the original. Advanced restores three motion choices and direct editing of every field. The territory dice remains available for a fast local seed.",
