  ...
  coffee: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Every new session freezes two distinct Library bots as staff, and neither joins the invited table. The foreground barista’s glowing, persona-shaped greeting asks whether you'd like coffee while the working barista moves between the grinder, espresso machine, and cleanup station. Have something made opens three choices: I’ll take the… accepts a guarded custom request, Surprise me creates a drink solely from the foreground barista’s persona, and Standard house blend skips generation. Custom and Surprise me are disabled in LOCAL, while the house blend remains available. After any cup order, the barista says “I’ll bring it to your seat” and the table starts immediately. Or Make the rounds to carry the pot instead; that role has no player mug and suppresses the ambient waiter for the whole session.",
      ...
      {
        heading: "Receive your drink",
        body: "Generated drinks can remain queued behind another image while the working barista prepares them in the background; reloads and ordinary app switching do not cancel the order. Either frozen barista may enter once the table is clear, place the finished drink, speak one short line when voice is enabled, and return to the bar. The silver Prism mug appears only after placement, with generated art clipped inside it. Click it for the existing six sips. The first sip of a Custom or Surprise me drink opens one real, replayable response from a firmly seated invited bot, followed by ten quiet seconds before ordinary autoplay resumes; later sips never retrigger it.",
        clickLabel: "your silver Prism mug after delivery",
        targetSelector: '[data-tutorial-target="composer"]',
      },
      {
        heading: "Join the conversation",
        body: "The live session stays overhead. Type into the message box or let the bots carry the room; click your silver rainbow mug to sip, or drag the pot to extend a bot's visit before its farewell begins. In a cup-role session, the barista occasionally tops off an eligible bot and offers your own refill as a quiet choice; all service stays outside the transcript, turn count, and memory. A bot whose Power refuses coffee has no mug, steam, sip, refill, waiter offer, or pot target; its invisible visit clock still winds down normally and cannot be refilled. Once an ordinary cup empties, that bot must leave within two or three table replies unless you top it off first, though mood and context can still send anyone home earlier. Put physical stage direction in the separate Action field using letters and spaces only; typing exactly ** in the speech field jumps there. Shh remains a separate interruption control, so it never replaces the table draft you are writing. Any idle audible bot may make a sparse prerecorded throat-clear, swallow, lip smack, sigh, or inhale; its mouth moves with the local cue, independent of its speaking style or voice engine. Watch a directly addressed bot: while listening, it may also give a small nod, lean, expression, brief spoken acknowledgement, or restrained ElevenLabs vocal reaction without taking a turn or entering the transcript. Your Cross-talk setting controls how often those contextual audible overlaps happen, from nearly silent in Rare to lively in Pile-up; inferred listeners remain visual only. When one bot cuts off another, the interrupter speaks a short hold-on over the outgoing voice before that voice releases; the interrupted bot takes a brief processing beat, then answers with an annoyed, abandoned ending over the handoff. The saved cutoff still shows only what reached the table. If a reply takes long enough to leave dead air, another seated bot may make one brief mood-aware aside without stealing the slow bot’s turn; the slow bot can begin answering over the aside’s natural ending. Ambient sips continue through quiet beats and listening moments, while the active speaker keeps their cup down; cup-return sounds stay synchronized with the visible cup motion. When an eligible bot has a non-neutral mood, Eleven v3 automatically carries that feeling into its next spoken line; neutral speech stays untagged. With Voice Effects on, longer bot turns may take a sparse mic-ready breath before speaking. A clear table goodbye ends the session naturally; Review stays quiet while the bots finish their private wrap. Prism's floating assistant steps out once the live Coffee Session begins and returns for setup, review, and replay. The finished Review keeps the saved table in view, groups its controls in a Signal-like header, and copies the full transcript to your clipboard instead of exporting a transcript file. Choose Video only when you want recording status or video download tools. PRISM still prepares a faithful third-person cut of the saved Coffee table automatically in the background, with your Prism avatar, frozen bot appearances and voices, synchronized dialogue, transcript seeking, video download, Retry, and Delete Recording. The final cut shows Prism leave first and each bot physically depart after the closing exchange. Video generation adds no AI conversation turn and continues in PRISM's isolated background renderer. Poll votes and team choices share the Table Talk rail; drag its left edge or the topic divider when you want more room.",
    ...
    steps: [
      {
        ...
        body: "Search by bot name or narrow the host list to one of your saved bot groups, then choose a host and optionally add a premise inspiration—the spark, tension, or reason this show should exist. Create show saves an editable fallback name and camera-ready PRISM set immediately, then automatically tries every supported identity asset in one pass: text identity, logo, matching Dark-to-Light studio pair and lighting map, plus the ident, outdent, and room-and-Foley atmosphere when you are Online. Right-click a host or guest anywhere in Signal to open that bot’s actions and Avatar Studio.",
      ...
      },
      {
        ...
        body: "The creation pass is resumable: Complete this show fills only missing pieces and keeps artwork already installed. The activity card tracks visual work in the background. Open the show-card gear for one identity row: click the logo for Generate or Upload, edit Name or Premise and leave the field to save, or use either compact dice. A blank Premise roll invents a fresh host-shaped show. Existing prose becomes source material; the more thoughtful and specific it is, the more Signal preserves its subjects, stakes, and intent while tightening the wording. A successful Premise roll also refreshes the dashboard blurbs automatically. Manual premise edits leave those blurbs alone. A muted host still uses only ..., while an echo-bound host keeps one persona-shaped blurb and repeats it forever.",
        clickLabel: "the show-card gear",
      ...
      {
        heading: "Replay or enhance audio",
        body: "Signal records one flattened live master from the same output buses heard on air, so overlapping voices, voice effects, soundboard cues, cup sounds, ambient vocal reactions, mic-ready breaths, avatar effects, action Foley, intro, outdent, room tone, and live fader levels stay together verbatim instead of being reconstructed after the session. The replay picture begins with the same branded intro and ends on the closing card, aligned to that master. Frozen voice takes and saved production events remain available only as a compatibility fallback for recordings made before live-master capture. Selecting a completed episode opens its replay immediately, with honest loading feedback while the episode arrives. Video export is disabled. Enhance recording is a separate explicit ONLINE action: after you confirm that the exact spoken transcript and selected voice IDs may be sent to ElevenLabs and consume credits, Signal uses Eleven v3 Text to Dialogue to create a more expressive spoken performance, then mixes it against the same saved effects and transcript timing. The enhanced audio remains separate and never overwrites the faithful recording. There are no post-episode camera controls and no second AI conversation turn. Copy for Signal Review still puts the complete conversation plus its private cues, per-turn model routing, delivery notes, segment changes, camera decisions, and outcome on your clipboard. Delete episode remains a separate destructive action.",
...
const COFFEE_GROUP_CREATION_LOADER_TUTORIAL_SUFFIX =
  "Creating a new Coffee Group opens a full-screen PRISM handoff while its name and conversation starters take shape.";
...
const SIGNAL_PRISM_PRESENCE_TUTORIAL_SUFFIX =
  "Prism's floating assistant steps out for the full live episode and returns on the show dashboard and in replay.";
...
function currentInterruptionRetortTutorialBody(body: string): string {
  return body
    ...
    .replace(
      "if the guest has the mic or is next, the host plays one of its saved short interjections while the guest’s annoyed cutoff overlaps and the continuation generates.",
      "if the guest has the mic or is next, the host plays one of its saved short interjections; the guest takes a brief processing beat before the annoyed cutoff retort while the continuation generates.",
    );
}
...
export const MODE_TUTORIALS: Record<TutorialMode, ModeTutorial> = {
  ...
  coffee: {
    ...
    steps: BASE_MODE_TUTORIALS.coffee.steps.map((step, index) => {
      ...
      return index === 0
        ? { ...step, body: `${body} ${COFFEE_GROUP_CREATION_LOADER_TUTORIAL_SUFFIX} ${POWER_EXCLUSION_TUTORIAL_SUFFIX} ${IDENTITY_MIRROR_POWER_TUTORIAL_SUFFIX} ${BOT_NAMING_POWER_TUTORIAL_SUFFIX}` }
        : index === 5
          ? {
              ...step,
    ...
    steps: BASE_MODE_TUTORIALS.botcast.steps.map((step, index) => {
      ...
      return index === 5
        ...
        : index === 7
          ? {
              ...step,
              body: `${body} ${SIGNAL_PRISM_PRESENCE_TUTORIAL_SUFFIX}`,
            }
        : body === step.body
          ? step
          : { ...step, body };
