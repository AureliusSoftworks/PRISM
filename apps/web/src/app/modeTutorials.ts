...
WHODUNNIT_TUTORIAL_STEP.body = WHODUNNIT_TUTORIAL_STEP.body.replace(
  "Click once to finish the reveal, then click again to close the observation and resume searching.",
  "While a dialogue box is visible, click any non-interactive part of the screen once to finish its reveal and again to close or advance it; double-click does both for silent text. During a voiced bot line, that gesture fades the voice and fills the caption without dismissing the line, so click once more when you are ready.",
);
