    ...
    steps: [
      {
        ...
        body: "A Debate is a saved exchange between two advocates. Basic setup is the welcoming default: give Prism a topic, choose the debaters, and keep evidence optional. During live bot-controlled speech, Debate can privately prepare the next automatic floor transition, but any objection, gavel, pause, input gate, or changed floor discards it before it reaches Proceedings. New Duel clears the active workbench without touching archived proceedings.",
        clickLabel: "New Duel",
        targetSelector: '[data-tutorial-target="debate-new"]',
      },
      {
        heading: "Choose Basic or Advanced",
        body: "Basic keeps setup focused on the debate idea, one Rowdiness dial, and two debaters. Prism writes the balanced motion and both private side briefs, starts with a Plainspoken Forum, automatically chooses one to three rebuttal rounds from the motion, brief depth, and evidence, opens from the center Judge seat, then stays silent until you act, leaves the final call to you, and keeps the Jury off. Advanced preserves the full studio: presets, five formality levels, Forum or Turnabout, player roles, editable briefs, the optional Jury, and Auto or a fixed one-to-three-round Forum. Auto is local and explainable; Turnabout stays action-driven. Daytime Showdown keeps its confrontation-show energy when you take the Judge role; Custom records the role change without turning Free-for-all into a polite panel. You can switch at any time; returning to Basic applies its simpler room defaults and Auto rounds while preserving your chosen Rowdiness, topic, cast, and sources.",
