...
WHODUNNIT_TUTORIAL_STEP.body = `${WHODUNNIT_TUTORIAL_STEP.body} Every dialogue caption types out at a deliberate courtroom-game pace. The current line's Babble or spoken performance follows that reveal; click, Enter, or Space once to complete and silence it immediately, then use the next gesture to advance. Room observations are attributed to the player character, use Babble whenever written accompaniment is on, and never auto-close. Only observations that produce a durable public case consequence—an admitted record, Case Kit recovery, or unlocked lead—enter the Case File's Observation Log with their room and player attribution. Frozen keys, codes, remotes, and other access objects also enter the Case Kit with an immediate acquisition cue. Settings → Debate lets other non-spoken dialogue follow Off, Babble, or Bottish while its text appears; spoken character TTS is unchanged.`
  ...
  .replace(
    ...
    "Move returns to PRISM’s shallow-isometric mansion and enters any unlocked room for free. Unvisited rooms reveal no occupant glyph. Visuals is a rainbow map mode that marks each room as Fallback, Default, or Upgraded without previewing its artwork. Selecting a marked room explains the state; ONLINE can create its mansion-specific Mosaic behind the full-screen PRISM loader, then offers the optional Upgraded presentation. Both passes preserve the frozen anchors, dynamic lights, doors, and examination geometry, and the artwork remains undisclosed until the room is visited. On first entry, the room opens clean and unblurred with no commands while the embodied Prosecutor's thought beat settles. Its name, glyph, normalized color, subtle glow, persona-specific wording, and Babble voice make clear whose thoughts you are hearing. Continue to begin a frozen three-line opening on the familiar blurred-room interview stage: your selected Prosecutor speaks first in its exact portrait and voice, the occupant answers, and the Prosecutor hands control back. Click, Enter, or Space completes the current line; the next gesture advances exactly one beat, with no dialogue choices or automatic skip. Music remains silent and Talk, Present, Examine, Move, Case File, and Theory stay locked until the final handoff settles on the occupant. The exact accepted lines and stage actions persist, local voices cache on demand, and first entry never calls an authoring model. Revisits skip the sequence. Earlier two-line cases retain their replay-stable compatibility introduction. On the Move map, Save venue level preserves the layout, anchors, lights, house direction, and accepted Mosaic/Upgraded room pairs as one protected level for later Whodunnit setup and future .mansion export. You can save before completing the investigation; saving does not unlock rooms, review examination points, or finish the case. Storage cleanup cannot remove an image still owned by that saved mansion.",
  )
  .replace(
...
WHODUNNIT_TUTORIAL_STEP.body = WHODUNNIT_TUTORIAL_STEP.body.replace(
  "Settings → Debate lets other non-spoken dialogue follow Off, Babble, or Bottish while its text appears; spoken character TTS is unchanged.",
  "Settings → Debate defaults written dialogue accompaniment to Babble; saved Off or Bottish choices remain yours. Spoken character TTS is unchanged.",
);
