  ...
  debate: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Forum is the backward-compatible default and opens in the Assembly Chamber, with parliamentary addresses, challenges, rebuttals, and a motion carried or defeated. Turnabout is a different format, not a theme: it enters the Court of Record as an original heightened courtroom examination where advocates give pressable testimony, the Judge or Participant can Press, Object, and Present Evidence, and the neutral moderator rules immediately. Its language and room response change with its rules. Every objection is bound to one statement and one evidence item frozen before Start. Spectators receive a moderator-led examination. Flyting and Cypher are visible as coming-later productions but cannot be selected or sent to the server. Changing executable format clears advocacy consent so no bot’s accepted role is silently broadened.",
