  ...
  chat: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Right-click in the canvas for shortcuts to settings, memories, images, and bot actions. In the account-wide Images hub, type the reusable prompt, then select Synthesize. Five recent general images stay in the rail and View all searches only general images, never Slate covers, Signal studios, logos, exhibits, or Atmospheres. Asset details can apply a cumulative local Reduce magenta pass, with Undo last pass available for each retained revision. Uploads appear only where an asset is actually needed, such as a cover, studio, exhibit, or Atmosphere. A running render can still queue up to eight more prompts with its captured model, keywords, privacy, and library.",
