  ...
  debate: {
    ...
    steps: [
      ...
      },
      {
        ...
        body: "Basic asks only for the debate idea and two debaters. Prism writes the balanced motion and both private side briefs, uses a Plainspoken Forum, moderates from the center, leaves the final call to you, and keeps the Jury off. Advanced preserves the full studio: presets, five formality levels, Forum or Turnabout, player roles, editable briefs, and the optional Jury. Daytime Showdown keeps its confrontation-show energy when you take the Judge role; Custom records the role change without turning Free-for-all into a polite panel. You can switch at any time; returning to Basic applies its simpler room defaults without deleting your topic, cast, or sources.",
        clickLabel: "Basic or Advanced",
        targetSelector: '[data-tutorial-target="debate-setup-mode"]',
      },
      {
        heading: "Name the presiding voice",
        body: "Moderator title is the exact public authority for this proceeding: Moderator, The House, The Court, or any title that fits your room. It appears on the center card, shapes how the moderator refers to itself and announces findings, and freezes with the saved Debate for replay. The title never changes the moderator bot’s identity, neutrality, Powers, or floor ownership.",
      ...
      },
      {
        ...
        body: "Basic asks you to choose the two advocates while Prism takes the center Judge / Moderator seat, speaks its procedural moderator lines in your player voice, and carries your Judge turns through that same avatar. Surprise me can fill both sides. Advanced adds Participant and Spectator roles, a Library moderator, Random actors, and the optional five-seat Jury. Only duplicate seating is blocked: Powers never make a bot ineligible for a role.",
        clickLabel: "Debaters",
      ...
      },
      {
        ...
        body: "Choose LOCAL, AUTO, or ONLINE and a primary Debate model in the navbar before setup work. AUTO quietly retries a failed or malformed generation through the fallback chain saved in Settings. Start freezes that ordered chain and the format version with the cast, sampled Jury, motion, consent, evidence, and resolved Powers; every generated statement and ballot records the model that actually handled it. If the whole chain fails, the proceeding pauses on the exact action and offers Retry or Skip without dialogue; Jury ballots are Retry-only. LOCAL remains a hard offline guarantee. Live Pause first calls the room to order with the moderator’s gavel and announcement, then suspends the proceeding and restores the entire navbar. Resume has the moderator or Judge call the proceeding back to order with a saved gavel action, preserves the exact next juror, discussion turn, ballot, or interrupted line, and locks the live-session controls again. Pause and Resume remain live procedural presentation only; neither housekeeping beat enters the readable proceedings or copied transcript. A human Judge waits through the same eight-second gavel cooldown before the context gavel or Pause becomes available again; bot-moderated roles may Pause again immediately. End early skips the remaining rounds: a Jury holds only three discussion turns and is told not to penalize unheard rounds. When the Jury is ready, choose Begin deliberation or Skip deliberation. Skipping can happen before any discussion or after it starts; it preserves all five final ballots and the full five-ballot Jury result. Judge and Participant input waits indefinitely until you act or pass.",
        clickLabel: "Start Forum or Start Turnabout",
        targetSelector: '[data-tutorial-target="debate-start"]',
      },
      {
        heading: "Use the Judge’s gavel",
        body: "When you are the Judge, Gavel stays available throughout the live proceeding, and Space swings it without reaching for the button. At scheduled procedural moments, a Gavel cue asks you to perform the strike yourself. That cue is ceremonial: your click or Space press only supplies the visible, audible slam, while the saved event and speaking order are already set. If you let the cue expire, no automatic gavel is faked; the room hangs for an awkward beat and the bots carry on. During an advocate’s overtime, the first strike stops the speaker and opens a two-second procedural burst. One strike earns a measured call-time line, two or three make Prism firmer, and four or more make the Judge sound aggravated. The whole burst remains one call-time action: it never opens choices, creates another message or ruling, or changes the resumed schedule. Overtime calls bypass any settling intervention cooldown without starting, extending, or erasing it. Outside a scheduled cue, the gavel calls the room to order and opens one message to both advocates; Prism routes the advocate best positioned to answer once, then resumes the exact interrupted schedule. Judge questions and interventions replace the caption with three one-tap responses and a fourth Write my own choice. Write my own reveals the standard composer at the bottom: type there, or use its dice to draft editable Judge prose before sending. A deliberately quiet fifth nevermind choice passes the question or resumes the interrupted schedule without adding Judge prose. Final rulings stay one-tap and still require a side. For two seconds after an ordinary intervention strike, hammer Space as much as you like: those extra smashes are pure showmanship. The eight-second server cooldown prevents a second deliberation, not a procedural overtime call.",
        clickLabel: "Gavel",
        targetSelector: '[data-tutorial-target="debate-judge-gavel"]',
      },
      {
        heading: "Read the living case",
        body: "Both formats stage each advocate's actual animated bot behind an authored side podium, with the moderator elevated between them when the frozen cast can perceive that body. The motion stays titled across the top of the chamber while perceptible words appear as synchronized broadcast captions along the bottom. Public prose arrives with the live voice; inaccessible speech never enters captions, voice, the shared case board, or listener-facing ballot reasons. On a sparse replay-stable roll, an advocate or visible juror whose own saved Persona genuinely finds an audible contribution contrary to expectation or newly explanatory may give one short in-character vocal reaction. It is atmosphere, not a new argument, vote, role change, relationship-memory read, or hidden Power reveal. A neutral floor marker keeps the proceeding legible without exposing hidden words. Each visible podium carries its bot's glyph; the bot that owns the current turn glows even when the turn is silent, so the cue follows floor ownership rather than speech or prose while stable bot ID remains canonical. Their frozen faces, ink, frame finishes, visibility, thinking, listening, and speaking states remain live throughout the proceeding. Judge choices take over the caption position at the moment of decision; Participant and Turnabout actions still rise in a full-width command deck. Forum keeps the scoreless case board and Participant interjections; only the heard fragment remains public before the moderator rules. Turnabout replaces that sequence with a public statement record: Press asks for clarification; Object opens the frozen evidence vault; Present Evidence sends one statement-and-evidence pair for grounded validation and an immediate ruling. Sustained contradictions create explicit reversals without inventing evidence. With Jury off, the seven generic Gallery Prisms remain nonbinding reactions. With Jury on, that strip becomes the frozen public roster.",
        clickLabel: "the living case board",
        targetSelector: '[data-tutorial-target="debate-case-board"]',
      },
      {
        heading: "Enter the Jury chamber",
        body: "Judges and Spectators can open the five-seat Jury camera at any point. The jurors follow the live case and trade short reactions between public-floor turns. An ellipsis beside a juror means a thought is waiting; enter the Jury camera before the next thought and that juror will deliver it, while another camera lets them resolve immediately without holding up the proceeding. PRISM matches the Light or Dark table, seats bot faces and frames around its transparent foreground, and carries active-speaker color, gaze, thinking, listening, speech, voice, and applicable visual Powers into the room. Five private leanings lead into five short routed discussion turns and five final ballots. Each audible juror reads the same final reason saved in the Jury record while their anonymous mark slides into a pile at the table’s center; a canonically silent juror still casts without gaining a voice. The foreperson then reads the split. Participants never mount this chamber and remain in a sealed state until five anonymous marks resolve into the aggregate. Auto then returns to the Forum for both advocates’ reactions before the Moderator closes, or before the human Judge delivers the final ruling.",
        clickLabel: "the Jury chamber",
        targetSelector: '[data-tutorial-target="debate-jury-chamber"]',
      },
      {
        heading: "Frame the floor",
        body: "Auto is the quiet default camera: it cuts instantly to Left for the For advocate, Moderator for the moderator, Right for the Against advocate, Wide whenever no bot owns the floor, and Jury when formal Jury resolution begins. Judges and Spectators can choose Jury manually at any point to watch its ongoing between-turn conversation. Procedural gavel cues also direct Auto to Moderator: one strike calls attention at every phase change, while two restore order for live interruptions, rulings, and verdicts, with the active moderator’s color carried through the instrument. A human Judge performs those scheduled strikes during the visible cue window; other roles keep the automatic moderator ceremony. On a two-strike cue, the first impact begins on the current shot and Auto lands on Moderator before the second. A canonically silent moderator can use that visible signal without speech. Forum and Turnabout both keep this procedural rhythm; Turnabout adds strikes around objections and reversals. The gavel is visible only in Moderator view. Choose a manual view to hold the shot. Camera choice changes presentation only—it never changes the saved transcript, case board, ballots, or speaking order.",
        clickLabel: "a Debate camera",
        targetSelector: '[data-tutorial-target="debate-camera"]',
      },
      {
        heading: "Follow and keep the record",
        body: "Proceedings render safe Markdown and source chips in the chamber's tonal transcript rail. It follows every growing live turn until you deliberately scroll back; choose Live to return to the newest phrase. Juror thoughts and deliberation stay out of Proceedings. After the verdict, Judges and Spectators get a separate timestamped Jury record with its own copy action, including between-turn thoughts they did not enter the chamber to hear. That Jury transcript remains directly copyable from its eligible Proceeding archive entry after you return to the Studio. With Jury off, a Judge's ruling is final and Participant or Spectator Duels use the traditional three-cast majority. With Jury on, the majority binds Spectators and Participants but advises a human Judge. The verdict is followed by both advocates’ public reactions; the bot Moderator then closes Spectator and Participant sessions, while the human Judge’s ruling closes Judge sessions. Judge and Spectator records keep named deliberation and ballots; Participant API responses, transcript copies, archives, and replay-facing event data retain only the aggregate split and verdict. Copy verbose transcript creates one review-ready role-safe record with frozen setup, runtime snapshots, evidence, event metadata, interruptions, moderator rulings, case-board state, and permitted public ballot reasons.",
