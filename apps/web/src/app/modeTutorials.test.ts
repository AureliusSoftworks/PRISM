...
describe("mode tutorials", () => {
  ...
  it("covers the complete Whodunnit investigation and trial loop", () => {
    ...
    assert.match(step.body, /shortest complete path/u);
    assert.match(step.body, /choose Quick, Standard, Grand, or Custom/u);
    assert.match(step.body, /leave Mansion idea blank for Surprise me/u);
    assert.match(step.body, /keep Classic for balanced deduction/u);
    assert.match(step.body, /does not require opening More case options/u);
    assert.match(step.body, /Installed Mansions is a dedicated library/u);
    assert.match(step.body, /Use this mansion/u);
    assert.match(step.body, /Random installed mansion/u);
    assert.match(step.body, /local library thumbnail, title, and description/u);
    assert.match(step.body, /immutable \.mansion file default/u);
    assert.match(step.body, /Install a mansion file/u);
    assert.match(step.body, /court tone, direct-to-court play, custom production/u);
    ...
    assert.match(step.body, /subdued live Prosecution and Defense minis/u);
    assert.match(step.body, /cut to the full Prosecution podium/u);
    assert.match(step.body, /direct rebuttals cut to Defense/u);
    assert.match(step.body, /compress to glyphs/u);
