...
describe("Zen live presence CSS", () => {
  ...
  it("keeps talking avatars still and flickers their lights instead", () => {
    ...
    assert.match(
      prismRule,
      /--bot-face-frame-tint-talking-opacity-high:\s*0\.96\s*;/,
    );
    assert.match(
      prismRule,
      /--bot-face-frame-tint-talking-opacity-mid:\s*0\.76\s*;/,
    );
    assert.match(
      prismRule,
      /--bot-face-frame-tint-talking-opacity-low:\s*0\.52\s*;/,
    );
    assert.match(
      prismRule,
  ...
  it("removes the Prism ambient aura from Zen mode", () => {
    ...
    assert.match(
      prismRule,
      /--bot-face-frame-tint-background:\s*[\s\S]*conic-gradient/,
    );
    ...
    assert.match(
      privatePrismRule,
      /--bot-face-frame-tint-background:\s*currentColor\s*;/,
    );
    assert.match(
      privatePrismRule,
      /--bot-face-frame-tint-opacity:\s*0\.52\s*;/,
    );
