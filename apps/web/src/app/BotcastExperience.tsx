...
// Alignment responses are buffered before playback begins, but a generated
// line should not leave the studio waiting indefinitely for its voice.
const SIGNAL_VOICE_START_TIMEOUT_MS = 12_000;
